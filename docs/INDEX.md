...
| EXPLORATION | 91% of trips are probes; tuition mispriced at booked fees; label unit economics | `docs/quant/2026-08-27_exploration_economics.md`, `docs/quant/2026-08-26_why_losing_deep_dive.md` | `scripts/cohort_eval.py` (SELECTION-ERA), `scripts/archetype_battery.py` + `scripts/trial_ledger.py` (null population, measured trials), audit census (`core/codes.py` SZ-047/ML-070/SZ-051) | registry TH-R-013; boundary arm 2D |
