...
| **POWER-1** | **gate power analysis (MinTRL/PSR)**: GROSS edge already established (MinTRL 10 < n=33, PSR 0.9991); NET needs 62 trades at configured fees (gate stops at 50) and **1,603 or INFINITE at true Kraken T1**. Two of three fee worlds are the pre-registered COST_BOUND arm. Makes FEE-3 (one read-only TradeVolume call) the highest-value single measurement in the project | `docs/quant/2026-08-22_gate_power_analysis_mintrl.md` |
