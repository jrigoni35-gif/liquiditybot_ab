...
_RANGES = {
    "ret_1": (-6, 6), "ret_6": (-6, 6), "ret_12": (-6, 6),
    "ret_48": (-6, 6),
    "sigma_bar_pct": (0, 5), "vol_percentile": (0, 1),
    "imbalance": (-2, 2), "spread_bps": (0, 6), "depth_log": (0, 3),
    "fv_edge_bps": (-5, 5), "basis_bps": (-8, 8),
    "volume_z": (-5, 5), "funding_bps": (-3, 3),
    "mom_score": (-1, 1), "drawdown_pct": (0, 0.9),
