# Overfit audit — 2026-07-18 20:25 UTC
...
- **PASS** pbo: DEPLOYED selection (simplicity ladder) not dominated by luck — pbo=0.14 over 8 configs / 70 splits (mean winner: logistic)
