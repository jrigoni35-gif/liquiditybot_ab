# Overfit audit — 2026-08-18 03:21 UTC

Dataset: SYNTHETIC benchmark (loaded rows=608 < 640) — validating machinery, not market
...
- **INFO** dsr — DEFERRED — 24 conviction-marked live trades < 30 (mixed n=332); mixed-sample dsr=0.000 sr=-0.48; probes are EV-mixed by design (PT-050); gate arms as conviction labels accrue
...
Corpus: SYNTHETIC benchmark (loaded rows=608 < 640) — validating machinery, not market
