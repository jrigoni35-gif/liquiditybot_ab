# Overfit audit — 2026-07-24 05:40 UTC

Dataset: live history (3571 rows)

- **FAIL** gap[logistic]: OOF gap within memorization band — train_auc=0.741 oof_auc=0.534 gap=+0.208
- **FAIL** gap[gbt]: OOF gap within memorization band — train_auc=0.720 oof_auc=0.504 gap=+0.216
- **FAIL** gap[mlp]: OOF gap within memorization band — train_auc=0.694 oof_auc=0.517 gap=+0.177
- **PASS** shuffle: destroyed labels learn nothing OOF — mean_auc=0.508 z=1.1 (limit 3.0)
- **INFO** pbo space — ml.adaptive_gbt.enabled=true — the adaptive rung is IN the measured selection space
- **FAIL** pbo: DEPLOYED selection (simplicity ladder) not dominated by luck — pbo=0.56 over 7 configs / 70 splits (mean winner: gbt_d3_lr10)
...
- **INFO** dof note — low/zero-importance: ['funding_dist', 'hour_cos', 'basis_dir', 'fv_edge_bps', 'other_ret_6_dir', 'th_stopzone'] ...
...
- **INFO** regime[range] oof — oof_n=2899 auc=0.550 (pooled 0.504, delta_auc=+0.047) brier=0.2652 (pooled 0.2653, delta_brier=-0.0001)
...
- **INFO** regime[bear] oof — oof_n=76 auc=0.503 (pooled 0.504, delta_auc=-0.001) brier=0.2705 (pooled 0.2653, delta_brier=+0.0051)
- **INFO** regime[crisis] — n=0 — absent from corpus
- **INFO** regime[unknown] — n=0 — absent from corpus

3 passed, 5 failed (126s)
