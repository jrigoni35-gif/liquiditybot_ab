...
- Window: 2026-07-13 10:33 UTC -> 2026-07-28 00:52 UTC (350.33h, ~1726 cycles)
- Equity: $800.00 -> $4,996.58 (range $4,201.35) | realized PnL $-3.42 | fees $2.07
- Activity: 0 open | 253 live labeled trades | 6183 candidates | 17 postmortems
- Model: level 1 | use_model=True | brier n/a | history_rows 253 | cold=True
- Audit: 1560 records (925 non-routine) | dominant OM-040 (22% of non-routine) | chain_ok=False (tamper=False, seams=4) | retrain_requests 120
...
- [WARN] **SD-002 model starvation loop**  -  model is cold (live training rows=253, brier=n/a) yet retrain was requested 120x  -  with 0 entries there is no new data, so retraining can never clear the condition. Seed a model (scripts/train_meta.py) or supply history; this loop is also 22% of the audit trail
