...
- Window: 2026-07-10 07:53 UTC -> 2026-09-14 11:29 UTC (1587.6h, ~1171 cycles)
- Equity (current capital epoch): $800.00 -> $781.45 (range $26.55) | 5 epochs lifetime, range $99,219.67 | realized PnL (post-close-fee) $-10.88 | fees (all legs) $22.79
- Activity: 5 open | 441 live labeled trades | 28695 candidates | 373 postmortems
- Model: level 0 | use_model=True | brier n/a | history_rows 441 | cold=False
- Audit: 88525 records (35191 non-routine) | dominant SZ-047 (63% of non-routine) | chain=SEAMS(60, benign) | retrain_requests 222
- Liquidity: spoofy 2% of non-liquid cycles | feed errors 8
- Recent (48h lens): 651 audit records | dominant ML-031 (16% of non-routine) | retrain_requests 8 | spoofy 2% (non-liquid)
...
## Diagnostics
- [WARN] **SD-011 audit fork carries divergent payloads**  -  1448 duplicated seq(s) whose rows disagree on (code, hash) - codes riding forks: {'LB-010': 392, 'SZ-051': 362, 'ML-070': 358, 'FW-050': 297, 'LB-050': 251, 'CX-030': 248, 'OM-040': 236, 'CV-010': 206, 'SZ-049': 165, 'FT-020': 140, 'CG-000': 133, 'ML-031': 122, 'CV-030': 77, 'OM-000': 75, 'SZ-052': 42, 'EN-000': 36, 'ML-016': 35, 'ML-042': 34, 'CV-000': 32, 'ML-041': 31, 'PT-061': 23, 'ML-032': 22, 'ML-030': 19, 'LB-000': 13, 'RT-010': 10, 'SZ-053': 10, 'FT-010': 8, 'ML-076': 7, 'ML-050': 6, 'LB-021': 5, 'ML-040': 4, 'SZ-047': 2, 'SZ-046': 2, 'LB-020': 2, 'OM-080': 1, 'OM-013': 1, 'RP-070': 1}; first examples: [{'seq': 503, 'codes': ['CG-000', 'RT-010'], 'ts': [1784239154.313, 1784239173.189]}, {'seq': 14864, 'codes': ['CG-000', 'SZ-047'], 'ts': [1785150021.206, 1785150150.318]}, {'seq': 14865, 'codes': ['FT-020', 'SZ-047'], 'ts': [1785150035.288, 1785150150.333]}]. Instruments consuming audit rows must not treat forked-seq rows as unique venue truth; find the writer (an unredirected script/harness - configure_audit exists for exactly this) and quarantine, never delete
