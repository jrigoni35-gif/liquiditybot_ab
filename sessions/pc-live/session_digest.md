...
- Window: 2026-07-10 07:53 UTC -> 2026-09-21 13:16 UTC (1757.39h, ~1915 cycles)
- Equity (current capital epoch): $800.00 -> $769.56 (range $39.09) | 5 epochs lifetime, range $99,232.21 | realized PnL (post-close-fee) $-18.55 | fees (all legs) $31.28
- Activity: 2 open | 479 live labeled trades | 31333 candidates | 405 postmortems
- Model: level 0 | use_model=True | brier n/a | history_rows 479 | cold=False
- Audit: 90165 records (36426 non-routine) | dominant SZ-047 (61% of non-routine) | chain=SEAMS(63, benign) | retrain_requests 250
- Liquidity: spoofy 8% of non-liquid cycles | feed errors 5
- Recent (48h lens): 326 audit records | dominant EN-000 (18% of non-routine) | retrain_requests 8 | spoofy 7% (non-liquid)
