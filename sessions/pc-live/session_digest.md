...
- Window: 2026-07-10 07:53 UTC -> 2026-09-21 17:17 UTC (1761.39h, ~2091 cycles)
- Equity (current capital epoch): $800.00 -> $769.46 (range $39.09) | 5 epochs lifetime, range $99,232.21 | realized PnL (post-close-fee) $-18.55 | fees (all legs) $31.39
- Activity: 3 open | 479 live labeled trades | 31360 candidates | 405 postmortems
- Model: level 0 | use_model=True | brier n/a | history_rows 479 | cold=False
- Audit: 90185 records (36444 non-routine) | dominant SZ-047 (61% of non-routine) | chain=SEAMS(63, benign) | retrain_requests 250
- Liquidity: spoofy 8% of non-liquid cycles | feed errors 5
- Recent (48h lens): 304 audit records | dominant EN-000 (19% of non-routine) | retrain_requests 8 | spoofy 7% (non-liquid)
