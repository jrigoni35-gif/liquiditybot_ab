...
- Window: 2026-07-10 07:53 UTC -> 2026-08-01 07:56 UTC (528.05h, ~356 cycles)
- Equity: $25,000.00 -> $4,940.18 (range $99,208.70) | realized PnL $-32.84 | fees $54.54
- Activity: 3 open | 269 live labeled trades | 7657 candidates | 229 postmortems
- Model: level 0 | use_model=True | brier n/a | history_rows 269 | cold=True
- Audit: 27792 records (25165 non-routine) | dominant SZ-047 (88% of non-routine) | chain_ok=False (tamper=False, seams=5) | retrain_requests 62
...
- [WARN] **SD-004 audit trail dominated by one code**  -  SZ-047 is 88% of 25165 non-routine records  -  consequential dispositions are buried; rate-limit that emitter
