...
- Window: 2026-07-10 07:53 UTC -> 2026-09-02 23:38 UTC (1311.75h, ~1112 cycles)
- Equity (current capital epoch): $800.00 -> $790.77 (range $16.38) | 5 epochs lifetime, range $99,209.50 | realized PnL (post-close-fee) $-3.19 | fees (all legs) $11.63
- Activity: 4 open | 397 live labeled trades | 22649 candidates | 334 postmortems
- Model: level 1 | use_model=True | brier n/a | history_rows 397 | cold=False
- Audit: 76627 records (31165 non-routine) | dominant SZ-047 (72% of non-routine) | chain=SEAMS(10, benign) | retrain_requests 178
- Liquidity: spoofy 68% of non-liquid cycles | feed errors 1
- Recent (48h lens): 6021 audit records | dominant LB-010 (33% of non-routine) | retrain_requests 7 | spoofy 68% (non-liquid)
- Eras: current 9-16ec821e | signal_history exec_era: unavailable (signal_history.csv has no exec_era column (95 columns; label_era present=True, a label-definition axis, not the execution era)) | fills per exec_era: {'prestamp': 1024, '7-e7d5ca1a': 133, '9-16ec821e': 39, '8-ca55e2ba': 10, 'absent(stale-binary)': 6, '4-aeeaae36': 4} (1216 rows) | pooling_hazard=True (source fills.exec_era)
- RAW signal-file span (signal_ts, all 23046 rows on disk): 2026-07-13T12:35:47Z -> 2026-09-02T20:20:00Z (51.32d) - NOT the TRAINED corpus span: era exclusion + the label_era filter drop rows, so the span the champion is SCORED on is shorter. For that one (the MinBTL / Sharpe-SE denominator) run scripts/champion_skill_report.py --json -> corpus_span_days
...
- [WARN] **SD-004 audit trail dominated by one code**  -  LB-010 is 33% of 437 non-routine records (last 48h)  -  consequential dispositions are buried; rate-limit that emitter
