...
- Window: 2026-07-10 07:53 UTC -> 2026-09-26 08:20 UTC (1872.45h, ~589 cycles)
- Equity (current capital epoch): $800.00 -> $762.76 (range $44.93) | 5 epochs lifetime, range $99,238.05 | realized PnL (post-close-fee) $-22.18 | fees (all legs) $37.14
- Activity: 4 open | 500 live labeled trades | 32820 candidates | 424 postmortems
- Model: level 0 | use_model=True | brier n/a | history_rows 500 | cold=False
- Audit: 91226 records (37252 non-routine) | dominant SZ-047 (60% of non-routine) | chain=SEAMS(63, benign) | retrain_requests 267
- Liquidity: spoofy 13% of non-liquid cycles | feed errors 0
- Recent (48h lens): 510 audit records | dominant LB-010 (21% of non-routine) | retrain_requests 7 | spoofy 13% (non-liquid)
