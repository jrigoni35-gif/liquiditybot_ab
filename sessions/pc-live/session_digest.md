...
- Window: 2026-07-10 07:53 UTC -> 2026-09-02 19:38 UTC (1307.75h, ~643 cycles)
- Equity (current capital epoch): $800.00 -> $790.86 (range $16.38) | 5 epochs lifetime, range $99,209.50 | realized PnL (post-close-fee) $-3.19 | fees (all legs) $11.60
- Activity: 3 open | 397 live labeled trades | 22587 candidates | 334 postmortems
- Model: level 1 | use_model=True | brier n/a | history_rows 397 | cold=False
- Audit: 76584 records (31136 non-routine) | dominant SZ-047 (72% of non-routine) | chain=SEAMS(10, benign) | retrain_requests 178
- Liquidity: spoofy 72% of non-liquid cycles | feed errors 1
- Recent (48h lens): 6095 audit records | dominant LB-010 (31% of non-routine) | retrain_requests 7 | spoofy 72% (non-liquid)
...
- [WARN] **SD-004 audit trail dominated by one code**  -  LB-010 is 31% of 435 non-routine records (last 48h)  -  consequential dispositions are buried; rate-limit that emitter
