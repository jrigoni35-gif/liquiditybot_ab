...
- Window: 2026-07-10 07:53 UTC -> 2026-09-17 00:32 UTC (1648.64h, ~854 cycles)
- Equity (current capital epoch): $800.00 -> $772.34 (range $35.08) | 5 epochs lifetime, range $99,228.20 | realized PnL (post-close-fee) $-16.92 | fees (all legs) $26.61
- Activity: 2 open | 456 live labeled trades | 29600 candidates | 386 postmortems
- Model: level 0 | use_model=True | brier n/a | history_rows 456 | cold=False
- Audit: 89254 records (35719 non-routine) | dominant SZ-047 (62% of non-routine) | chain=SEAMS(61, benign) | retrain_requests 232
- Liquidity: spoofy 2% of non-liquid cycles | feed errors 4
- Recent (48h lens): 565 audit records | dominant LB-010 (22% of non-routine) | retrain_requests 8 | spoofy 2% (non-liquid)
- Eras: current 12-10d4d0c2 | signal_history exec_era: unavailable (signal_history.csv has no exec_era column (95 columns; label_era present=True, a label-definition axis, not the execution era)) | fills per exec_era: {'prestamp': 1030, '7-e7d5ca1a': 133, '12-10d4d0c2': 78, '9-16ec821e': 68, '8-ca55e2ba': 10, '10-a5acfe2d': 9, '11-6e584923': 8, '4-aeeaae36': 4} (1340 rows) | pooling_hazard=True (source fills.exec_era)
- RAW signal-file span (signal_ts, all 30056 rows on disk): 2026-07-13T12:35:47Z -> 2026-09-16T22:35:00Z (65.42d) - NOT the TRAINED corpus span: era exclusion + the label_era filter drop rows, so the span the champion is SCORED on is shorter. For that one (the MinBTL / Sharpe-SE denominator) run scripts/champion_skill_report.py --json -> corpus_span_days
