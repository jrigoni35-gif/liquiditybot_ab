...
- Window: 2026-07-10 07:53 UTC -> 2026-09-05 12:41 UTC (1372.8h, ~1495 cycles)
- Equity (current capital epoch): $800.00 -> $792.67 (range $16.78) | 5 epochs lifetime, range $99,209.90 | realized PnL (post-close-fee) $-1.37 | fees (all legs) $13.42
- Activity: 4 open | 409 live labeled trades | 24643 candidates | 342 postmortems
- Model: level 1 | use_model=True | brier n/a | history_rows 409 | cold=False
- Audit: 77805 records (32232 non-routine) | dominant SZ-047 (69% of non-routine) | chain=SEAMS(13, benign) | retrain_requests 189
- Liquidity: spoofy 79% of non-liquid cycles | feed errors 1
- Recent (48h lens): 1063 audit records | dominant LB-010 (18% of non-routine) | retrain_requests 9 | spoofy 79% (non-liquid)
...
- [INFO] **SD-010 audit writer seam(s)**  -  13 hash-valid concurrent-writer fork(s) in the chain - benign (no committed record altered); prevention: runner instance lock + one-bot mode
