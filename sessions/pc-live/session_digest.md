...
- Window: 2026-07-10 07:53 UTC -> 2026-09-06 16:42 UTC (1400.82h, ~1413 cycles)
- Equity (current capital epoch): $800.00 -> $793.53 (range $16.78) | 5 epochs lifetime, range $99,209.90 | realized PnL (post-close-fee) $-0.57 | fees (all legs) $13.92
- Activity: 2 open | 412 live labeled trades | 25434 candidates | 347 postmortems
- Model: level 0 | use_model=True | brier n/a | history_rows 412 | cold=False
- Audit: 82642 records (32487 non-routine) | dominant SZ-047 (69% of non-routine) | chain=SEAMS(16, benign) | retrain_requests 195
- Liquidity: spoofy 65% of non-liquid cycles | feed errors 2
- Recent (48h lens): 5584 audit records | dominant LB-010 (20% of non-routine) | retrain_requests 10 | spoofy 65% (non-liquid)
