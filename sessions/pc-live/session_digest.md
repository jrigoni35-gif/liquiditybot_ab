...
- Window: 2026-07-10 07:53 UTC -> 2026-09-02 20:38 UTC (1308.75h, ~759 cycles)
- Equity (current capital epoch): $800.00 -> $791.39 (range $16.38) | 5 epochs lifetime, range $99,209.50 | realized PnL (post-close-fee) $-3.19 | fees (all legs) $11.60
- Activity: 3 open | 397 live labeled trades | 22624 candidates | 334 postmortems
- Model: level 1 | use_model=True | brier n/a | history_rows 397 | cold=False
- Audit: 76590 records (31142 non-routine) | dominant SZ-047 (72% of non-routine) | chain=SEAMS(10, benign) | retrain_requests 178
- Liquidity: spoofy 70% of non-liquid cycles | feed errors 1
- Recent (48h lens): 6100 audit records | dominant LB-010 (31% of non-routine) | retrain_requests 7 | spoofy 70% (non-liquid)
...
- [WARN] **SD-004 audit trail dominated by one code**  -  LB-010 is 31% of 440 non-routine records (last 48h)  -  consequential dispositions are buried; rate-limit that emitter
