...
- Window: 2026-07-10 07:53 UTC -> 2026-09-01 03:37 UTC (1267.73h, ~2117 cycles)
- Equity (current capital epoch): $800.00 -> $796.00 (range $12.30) | 5 epochs lifetime, range $99,208.70 | realized PnL (post-close-fee) $-0.73 | fees (all legs) $10.40
- Activity: 4 open | 389 live labeled trades | 21187 candidates | 326 postmortems
- Model: level 1 | use_model=True | brier n/a | history_rows 389 | cold=False
- Audit: 70673 records (30761 non-routine) | dominant SZ-047 (72% of non-routine) | chain=SEAMS(10, benign) | retrain_requests 171
- Liquidity: spoofy 64% of non-liquid cycles | feed errors 1059
- Recent (48h lens): 601 audit records | dominant LB-010 (24% of non-routine) | retrain_requests 7 | spoofy 64% (non-liquid)
