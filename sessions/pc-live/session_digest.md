...
- Window: 2026-07-10 07:53 UTC -> 2026-07-23 22:43 UTC (326.84h, ~1606 cycles)
- Equity: $25,000.00 -> $4,965.79 (range $99,208.70) | realized PnL $-19.97 | fees $34.47
- Activity: 1 open | 239 live labeled trades | 3350 candidates | 204 postmortems
- Model: level 2 | use_model=False | brier n/a | history_rows 239 | cold=True
- Audit: 4813 records (2255 non-routine) | dominant OM-000 (24% of non-routine) | chain_ok=False (tamper=False, seams=2) | retrain_requests 35
- Liquidity: spoofy 76% of classified cycles | feed errors 0

## Diagnostics
- [WARN] **SD-002 model starvation loop**  -  model is cold (live training rows=239, brier=n/a) yet retrain was requested 35x  -  with 0 entries there is no new data, so retraining can never clear the condition. Seed a model (scripts/train_meta.py) or supply history; this loop is also 24% of the audit trail
