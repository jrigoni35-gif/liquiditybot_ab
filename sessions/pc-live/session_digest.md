...
- Window: 2026-07-10 07:53 UTC -> 2026-09-01 01:37 UTC (1265.73h, ~1883 cycles)
- Equity (current capital epoch): $800.00 -> $795.21 (range $12.30) | 5 epochs lifetime, range $99,208.70 | realized PnL (post-close-fee) $-0.73 | fees (all legs) $10.40
- Activity: 4 open | 389 live labeled trades | 21143 candidates | 326 postmortems
- Model: level 1 | use_model=True | brier n/a | history_rows 389 | cold=False
- Audit: 70621 records (30743 non-routine) | dominant SZ-047 (72% of non-routine) | chain=SEAMS(10, benign) | retrain_requests 171
- Liquidity: spoofy 63% of non-liquid cycles | feed errors 1059
- Recent (48h lens): 728 audit records | dominant LB-010 (23% of non-routine) | retrain_requests 7 | spoofy 63% (non-liquid)
