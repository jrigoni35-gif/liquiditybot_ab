...
- Window: 2026-07-10 07:53 UTC -> 2026-09-06 06:42 UTC (1390.81h, ~250 cycles)
- Equity (current capital epoch): $800.00 -> $793.83 (range $16.78) | 5 epochs lifetime, range $99,209.90 | realized PnL (post-close-fee) $-0.57 | fees (all legs) $13.92
- Activity: 2 open | 412 live labeled trades | 25087 candidates | 347 postmortems
- Model: level 0 | use_model=True | brier n/a | history_rows 412 | cold=False
- Audit: 79637 records (32382 non-routine) | dominant SZ-047 (69% of non-routine) | chain=SEAMS(16, benign) | retrain_requests 194
- Liquidity: spoofy 63% of non-liquid cycles | feed errors 0
- Recent (48h lens): 2621 audit records | dominant LB-010 (18% of non-routine) | retrain_requests 11 | spoofy 63% (non-liquid)
