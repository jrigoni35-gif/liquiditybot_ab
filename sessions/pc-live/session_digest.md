...
- Window: 2026-07-10 07:53 UTC -> 2026-09-10 13:29 UTC (1493.6h, ~582 cycles)
- Equity (current capital epoch): $800.00 -> $785.86 (range $21.90) | 5 epochs lifetime, range $99,215.02 | realized PnL (post-close-fee) $-3.78 | fees (all legs) $17.94
- Activity: 4 open | 425 live labeled trades | 27503 candidates | 356 postmortems
- Model: level 0 | use_model=True | brier n/a | history_rows 425 | cold=False
- Audit: 86050 records (33180 non-routine) | dominant SZ-047 (67% of non-routine) | chain=SEAMS(54, benign) | retrain_requests 207
- Liquidity: spoofy 0% of non-liquid cycles | feed errors 6
- Recent (48h lens): 459 audit records | dominant LB-010 (32% of non-routine) | retrain_requests 4 | spoofy 0% (non-liquid)
...
- [WARN] **SD-004 audit trail dominated by one code**  -  LB-010 is 32% of 364 non-routine records (last 48h)  -  consequential dispositions are buried; rate-limit that emitter
