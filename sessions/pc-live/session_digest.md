...
- Window: 2026-07-10 07:53 UTC -> 2026-09-19 01:14 UTC (1697.34h, ~73 cycles)
- Equity (current capital epoch): $800.00 -> $774.05 (range $35.96) | 5 epochs lifetime, range $99,229.08 | realized PnL (post-close-fee) $-15.71 | fees (all legs) $28.71
- Activity: 3 open | 465 live labeled trades | 30405 candidates | 392 postmortems
- Model: level 0 | use_model=True | brier n/a | history_rows 465 | cold=False
- Audit: 89667 records (36078 non-routine) | dominant SZ-047 (62% of non-routine) | chain=SEAMS(63, benign) | retrain_requests 240
- Liquidity: spoofy 10% of non-liquid cycles | feed errors 0
- Recent (48h lens): 397 audit records | dominant EN-000 (14% of non-routine) | retrain_requests 8 | spoofy 10% (non-liquid)
