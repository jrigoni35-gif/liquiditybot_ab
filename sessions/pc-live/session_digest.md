...
- Window: 2026-07-10 07:53 UTC -> 2026-07-22 00:42 UTC (280.81h, ~630 cycles)
- Equity: $25,000.00 -> $4,990.17 (range $99,208.70) | realized PnL $-5.34 | fees $11.10
- Activity: 0 open | 106 live labeled trades | 2306 candidates | 91 postmortems
- Model: level 0 | use_model=True | brier n/a | history_rows 106 | cold=True
- Audit: 1873 records (757 non-routine) | dominant OM-000 (33% of non-routine) | chain_ok=False (tamper=False, seams=2) | retrain_requests 28
...
- [WARN] **SD-004 audit trail dominated by one code**  -  OM-000 is 33% of 757 non-routine records  -  consequential dispositions are buried; rate-limit that emitter
