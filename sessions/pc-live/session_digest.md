...
- Window: 2026-07-10 07:53 UTC -> 2026-08-31 20:36 UTC (1260.72h, ~1300 cycles)
- Equity (current capital epoch): $800.00 -> $795.64 (range $12.30) | 5 epochs lifetime, range $99,208.70 | realized PnL (post-close-fee) $-0.73 | fees (all legs) $10.35
- Activity: 3 open | 389 live labeled trades | 21049 candidates | 326 postmortems
- Model: level 1 | use_model=True | brier n/a | history_rows 389 | cold=False
- Audit: 70490 records (30702 non-routine) | dominant SZ-047 (72% of non-routine) | chain=SEAMS(10, benign) | retrain_requests 171
- Liquidity: spoofy 64% of non-liquid cycles | feed errors 1059
- Recent (48h lens): 669 audit records | dominant LB-010 (25% of non-routine) | retrain_requests 8 | spoofy 64% (non-liquid)
