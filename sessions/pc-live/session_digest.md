...
- Window: 2026-07-10 07:53 UTC -> 2026-07-21 10:42 UTC (266.81h, ~1104 cycles)
- Equity: $25,000.00 -> $4,992.18 (range $99,208.70) | realized PnL $-4.18 | fees $9.05
- Activity: 0 open | 92 live labeled trades | 2172 candidates | 76 postmortems
- Model: level 2 | use_model=False | brier n/a | history_rows 92 | cold=True
- Audit: 1486 records (667 non-routine) | dominant OM-000 (33% of non-routine) | chain_ok=False (tamper=False, seams=2) | retrain_requests 26
...
- [WARN] **SD-004 audit trail dominated by one code**  -  OM-000 is 33% of 667 non-routine records  -  consequential dispositions are buried; rate-limit that emitter
