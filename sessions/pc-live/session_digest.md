...
- Window: 2026-07-10 07:53 UTC -> 2026-09-03 03:39 UTC (1315.76h, ~1579 cycles)
- Equity (current capital epoch): $800.00 -> $791.18 (range $16.65) | 5 epochs lifetime, range $99,209.77 | realized PnL (post-close-fee) $-3.47 | fees (all legs) $11.69
- Activity: 4 open | 398 live labeled trades | 22995 candidates | 335 postmortems
- Model: level 1 | use_model=True | brier n/a | history_rows 398 | cold=False
- Audit: 76671 records (31204 non-routine) | dominant SZ-047 (71% of non-routine) | chain=SEAMS(10, benign) | retrain_requests 179
- Liquidity: spoofy 67% of non-liquid cycles | feed errors 1
- Recent (48h lens): 5996 audit records | dominant LB-010 (33% of non-routine) | retrain_requests 8 | spoofy 67% (non-liquid)
- Eras: current 9-16ec821e | signal_history exec_era: unavailable (signal_history.csv has no exec_era column (95 columns; label_era present=True, a label-definition axis, not the execution era)) | fills per exec_era: {'prestamp': 1024, '7-e7d5ca1a': 133, '9-16ec821e': 41, '8-ca55e2ba': 10, 'absent(stale-binary)': 6, '4-aeeaae36': 4} (1218 rows) | pooling_hazard=True (source fills.exec_era)
- RAW signal-file span (signal_ts, all 23393 rows on disk): 2026-07-13T12:35:47Z -> 2026-09-03T02:25:00Z (51.58d) - NOT the TRAINED corpus span: era exclusion + the label_era filter drop rows, so the span the champion is SCORED on is shorter. For that one (the MinBTL / Sharpe-SE denominator) run scripts/champion_skill_report.py --json -> corpus_span_days
...
- [WARN] **SD-004 audit trail dominated by one code**  -  LB-010 is 33% of 441 non-routine records (last 48h)  -  consequential dispositions are buried; rate-limit that emitter
