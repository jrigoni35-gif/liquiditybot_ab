...
- Window: 2026-07-10 07:53 UTC -> 2026-09-02 01:38 UTC (1289.75h, ~1493 cycles)
- Equity (current capital epoch): $800.00 -> $792.86 (range $14.33) | 5 epochs lifetime, range $99,208.70 | realized PnL (post-close-fee) $-1.69 | fees (all legs) $10.73
- Activity: 4 open | 391 live labeled trades | 22099 candidates | 328 postmortems
- Model: level 1 | use_model=True | brier n/a | history_rows 391 | cold=False
- Audit: 76415 records (31008 non-routine) | dominant SZ-047 (72% of non-routine) | chain=SEAMS(10, benign) | retrain_requests 175
- Liquidity: spoofy 61% of non-liquid cycles | feed errors 2
- Recent (48h lens): 5992 audit records | dominant LB-010 (27% of non-routine) | retrain_requests 7 | spoofy 61% (non-liquid)
- Eras: current 9-16ec821e | signal_history exec_era: unavailable (signal_history.csv has no exec_era column (95 columns; label_era present=True, a label-definition axis, not the execution era)) | fills per exec_era: {'prestamp': 1024, '7-e7d5ca1a': 133, '9-16ec821e': 26, '8-ca55e2ba': 10, 'absent(stale-binary)': 6, '4-aeeaae36': 4} (1203 rows) | pooling_hazard=True (source fills.exec_era)
