...
- Window: 2026-07-10 07:53 UTC -> 2026-09-23 00:17 UTC (1792.4h, ~543 cycles)
- Equity (current capital epoch): $800.00 -> $768.38 (range $39.75) | 5 epochs lifetime, range $99,232.87 | realized PnL (post-close-fee) $-18.34 | fees (all legs) $32.55
- Activity: 5 open | 483 live labeled trades | 31591 candidates | 409 postmortems
- Model: level 0 | use_model=True | brier n/a | history_rows 483 | cold=False
- Audit: 90410 records (36609 non-routine) | dominant SZ-047 (61% of non-routine) | chain=SEAMS(63, benign) | retrain_requests 255
- Liquidity: spoofy 7% of non-liquid cycles | feed errors 1
- Recent (48h lens): 320 audit records | dominant EN-000 (20% of non-routine) | retrain_requests 7 | spoofy 7% (non-liquid)
