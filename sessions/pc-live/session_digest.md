...
- Window: 2026-07-10 07:53 UTC -> 2026-09-02 07:38 UTC (1295.75h, ~2198 cycles)
- Equity (current capital epoch): $800.00 -> $793.10 (range $14.49) | 5 epochs lifetime, range $99,208.70 | realized PnL (post-close-fee) $-1.95 | fees (all legs) $11.09
- Activity: 5 open | 393 live labeled trades | 22297 candidates | 330 postmortems
- Model: level 1 | use_model=True | brier n/a | history_rows 393 | cold=False
- Audit: 76471 records (31048 non-routine) | dominant SZ-047 (72% of non-routine) | chain=SEAMS(10, benign) | retrain_requests 176
- Liquidity: spoofy 63% of non-liquid cycles | feed errors 2
- Recent (48h lens): 6020 audit records | dominant LB-010 (28% of non-routine) | retrain_requests 7 | spoofy 63% (non-liquid)
- Eras: current 9-16ec821e | signal_history exec_era: unavailable (signal_history.csv has no exec_era column (95 columns; label_era present=True, a label-definition axis, not the execution era)) | fills per exec_era: {'prestamp': 1024, '7-e7d5ca1a': 133, '9-16ec821e': 32, '8-ca55e2ba': 10, 'absent(stale-binary)': 6, '4-aeeaae36': 4} (1209 rows) | pooling_hazard=True (source fills.exec_era)
- RAW signal-file span (signal_ts, all 22690 rows on disk): 2026-07-13T12:35:47Z -> 2026-09-02T05:40:00Z (50.71d) - NOT the TRAINED corpus span: era exclusion + the label_era filter drop rows, so the span the champion is SCORED on is shorter. For that one (the MinBTL / Sharpe-SE denominator) run scripts/champion_skill_report.py --json -> corpus_span_days
