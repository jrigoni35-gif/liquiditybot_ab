...
- Window: 2026-07-10 07:53 UTC -> 2026-09-03 19:39 UTC (1331.76h, ~244 cycles)
- Equity (current capital epoch): $800.00 -> $795.55 (range $16.78) | 5 epochs lifetime, range $99,209.90 | realized PnL (post-close-fee) $-2.97 | fees (all legs) $12.29
- Activity: 2 open | 403 live labeled trades | 23611 candidates | 339 postmortems
- Model: level 1 | use_model=True | brier n/a | history_rows 403 | cold=False
- Audit: 76821 records (31342 non-routine) | dominant SZ-047 (71% of non-routine) | chain=SEAMS(10, benign) | retrain_requests 181
- Liquidity: spoofy 62% of non-liquid cycles | feed errors 0
- Recent (48h lens): 1786 audit records | dominant LB-010 (36% of non-routine) | retrain_requests 7 | spoofy 62% (non-liquid)
...
- [WARN] **SD-004 audit trail dominated by one code**  -  LB-010 is 36% of 405 non-routine records (last 48h)  -  consequential dispositions are buried; rate-limit that emitter
