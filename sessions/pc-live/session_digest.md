...
- Window: 2026-07-10 07:53 UTC -> 2026-09-03 11:39 UTC (1323.76h, ~2515 cycles)
- Equity (current capital epoch): $800.00 -> $791.28 (range $16.78) | 5 epochs lifetime, range $99,209.90 | realized PnL (post-close-fee) $-3.83 | fees (all legs) $11.77
- Activity: 5 open | 399 live labeled trades | 23160 candidates | 336 postmortems
- Model: level 1 | use_model=True | brier n/a | history_rows 399 | cold=False
- Audit: 76734 records (31263 non-routine) | dominant SZ-047 (71% of non-routine) | chain=SEAMS(10, benign) | retrain_requests 180
- Liquidity: spoofy 69% of non-liquid cycles | feed errors 1
- Recent (48h lens): 4336 audit records | dominant LB-010 (35% of non-routine) | retrain_requests 8 | spoofy 69% (non-liquid)
...
- [WARN] **SD-004 audit trail dominated by one code**  -  LB-010 is 35% of 419 non-routine records (last 48h)  -  consequential dispositions are buried; rate-limit that emitter
