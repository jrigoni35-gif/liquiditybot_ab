...
- Window: 2026-07-10 07:53 UTC -> 2026-09-16 05:31 UTC (1629.63h, ~321 cycles)
- Equity (current capital epoch): $800.00 -> $775.67 (range $31.49) | 5 epochs lifetime, range $99,224.61 | realized PnL (post-close-fee) $-12.93 | fees (all legs) $25.27
- Activity: 3 open | 451 live labeled trades | 29230 candidates | 381 postmortems
- Model: level 0 | use_model=True | brier n/a | history_rows 451 | cold=False
- Audit: 88928 records (35459 non-routine) | dominant SZ-047 (63% of non-routine) | chain=SEAMS(61, benign) | retrain_requests 229
- Liquidity: spoofy 1% of non-liquid cycles | feed errors 0
- Recent (48h lens): 469 audit records | dominant EN-000 (17% of non-routine) | retrain_requests 8 | spoofy 1% (non-liquid)
- Eras: current 12-10d4d0c2 | signal_history exec_era: unavailable (signal_history.csv has no exec_era column (95 columns; label_era present=True, a label-definition axis, not the execution era)) | fills per exec_era: {'prestamp': 1030, '7-e7d5ca1a': 133, '12-10d4d0c2': 69, '9-16ec821e': 68, '8-ca55e2ba': 10, '10-a5acfe2d': 9, '11-6e584923': 8, '4-aeeaae36': 4} (1331 rows) | pooling_hazard=True (source fills.exec_era)
- RAW signal-file span (signal_ts, all 29681 rows on disk): 2026-07-13T12:35:47Z -> 2026-09-16T00:55:00Z (64.51d) - NOT the TRAINED corpus span: era exclusion + the label_era filter drop rows, so the span the champion is SCORED on is shorter. For that one (the MinBTL / Sharpe-SE denominator) run scripts/champion_skill_report.py --json -> corpus_span_days
