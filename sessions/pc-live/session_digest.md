...
- Window: 2026-07-10 07:53 UTC -> 2026-07-25 21:44 UTC (373.86h, ~772 cycles)
- Equity: $25,000.00 -> $4,965.86 (range $99,208.70) | realized PnL $-19.90 | fees $34.54
- Activity: 0 open | 240 live labeled trades | 4425 candidates | 204 postmortems
- Model: level 2 | use_model=False | brier n/a | history_rows 240 | cold=True
- Audit: 11271 records (8713 non-routine) | dominant SZ-047 (77% of non-routine) | chain_ok=False (tamper=False, seams=2) | retrain_requests 40
...
- [WARN] **SD-004 audit trail dominated by one code**  -  SZ-047 is 77% of 8713 non-routine records  -  consequential dispositions are buried; rate-limit that emitter
