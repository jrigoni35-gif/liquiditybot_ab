...
- Window: 2026-07-10 07:53 UTC -> 2026-07-30 02:54 UTC (475.02h, ~435 cycles)
- Equity: $25,000.00 -> $4,963.82 (range $99,208.70) | realized PnL $-21.58 | fees $38.81
- Activity: 2 open | 253 live labeled trades | 6256 candidates | 212 postmortems
- Model: level 0 | use_model=True | brier n/a | history_rows 253 | cold=True
- Audit: 24418 records (21848 non-routine) | dominant SZ-047 (89% of non-routine) | chain_ok=False (tamper=False, seams=5) | retrain_requests 54
...
- [WARN] **SD-004 audit trail dominated by one code**  -  SZ-047 is 89% of 21848 non-routine records  -  consequential dispositions are buried; rate-limit that emitter
