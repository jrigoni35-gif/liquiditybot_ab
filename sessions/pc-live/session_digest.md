...
- Window: 2026-07-10 07:53 UTC -> 2026-08-29 20:35 UTC (1212.7h, ~2448 cycles)
- Equity (current capital epoch): $800.00 -> $798.37 (range $10.12) | 5 epochs lifetime, range $99,208.70 | realized PnL (post-close-fee) $2.39 | fees (all legs) $8.30
- Activity: 5 open | 376 live labeled trades | 18970 candidates | 314 postmortems
- Model: level 0 | use_model=True | brier n/a | history_rows 376 | cold=False
- Audit: 69821 records (30243 non-routine) | dominant SZ-047 (74% of non-routine) | chain=SEAMS(9, benign) | retrain_requests 163
- Liquidity: spoofy 73% of non-liquid cycles | feed errors 0
- Recent (48h lens): 587 audit records | dominant LB-010 (37% of non-routine) | retrain_requests 8 | spoofy 73% (non-liquid)
...
- [WARN] **SD-004 audit trail dominated by one code**  -  LB-010 is 37% of 534 non-routine records (last 48h)  -  consequential dispositions are buried; rate-limit that emitter
