...
- Window: 2026-07-10 07:53 UTC -> 2026-09-04 14:40 UTC (1350.77h, ~2473 cycles)
- Equity (current capital epoch): $800.00 -> $793.47 (range $16.78) | 5 epochs lifetime, range $99,209.90 | realized PnL (post-close-fee) $-0.55 | fees (all legs) $12.88
- Activity: 3 open | 407 live labeled trades | 24260 candidates | 342 postmortems
- Model: level 1 | use_model=True | brier n/a | history_rows 407 | cold=False
- Audit: 77049 records (31536 non-routine) | dominant SZ-047 (71% of non-routine) | chain=SEAMS(10, benign) | retrain_requests 184
- Liquidity: spoofy 67% of non-liquid cycles | feed errors 0
- Recent (48h lens): 496 audit records | dominant LB-010 (31% of non-routine) | retrain_requests 7 | spoofy 67% (non-liquid)
...
- [WARN] **SD-004 audit trail dominated by one code**  -  LB-010 is 31% of 427 non-routine records (last 48h)  -  consequential dispositions are buried; rate-limit that emitter
