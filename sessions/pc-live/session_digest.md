...
- Window: 2026-07-10 07:53 UTC -> 2026-09-06 02:41 UTC (1386.81h, ~3113 cycles)
- Equity (current capital epoch): $800.00 -> $793.82 (range $16.78) | 5 epochs lifetime, range $99,209.90 | realized PnL (post-close-fee) $-0.57 | fees (all legs) $13.92
- Activity: 2 open | 412 live labeled trades | 24969 candidates | 347 postmortems
- Model: level 0 | use_model=True | brier n/a | history_rows 412 | cold=False
- Audit: 78618 records (32343 non-routine) | dominant SZ-047 (69% of non-routine) | chain=SEAMS(16, benign) | retrain_requests 193
- Liquidity: spoofy 76% of non-liquid cycles | feed errors 3
- Recent (48h lens): 1650 audit records | dominant LB-010 (17% of non-routine) | retrain_requests 11 | spoofy 76% (non-liquid)
