...
- Window: 2026-07-10 07:53 UTC -> 2026-09-03 13:39 UTC (1325.76h, ~2749 cycles)
- Equity (current capital epoch): $800.00 -> $792.46 (range $16.78) | 5 epochs lifetime, range $99,209.90 | realized PnL (post-close-fee) $-3.83 | fees (all legs) $11.77
- Activity: 5 open | 399 live labeled trades | 23269 candidates | 336 postmortems
- Model: level 1 | use_model=True | brier n/a | history_rows 399 | cold=False
- Audit: 76748 records (31277 non-routine) | dominant SZ-047 (71% of non-routine) | chain=SEAMS(10, benign) | retrain_requests 180
- Liquidity: spoofy 68% of non-liquid cycles | feed errors 2
- Recent (48h lens): 3673 audit records | dominant LB-010 (35% of non-routine) | retrain_requests 7 | spoofy 68% (non-liquid)
...
- [WARN] **SD-004 audit trail dominated by one code**  -  LB-010 is 35% of 412 non-routine records (last 48h)  -  consequential dispositions are buried; rate-limit that emitter
