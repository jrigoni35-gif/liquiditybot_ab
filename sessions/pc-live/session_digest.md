...
- Window: 2026-07-10 07:53 UTC -> 2026-09-03 02:39 UTC (1314.76h, ~1462 cycles)
- Equity (current capital epoch): $800.00 -> $791.47 (range $16.65) | 5 epochs lifetime, range $99,209.77 | realized PnL (post-close-fee) $-3.47 | fees (all legs) $11.67
- Activity: 3 open | 398 live labeled trades | 22870 candidates | 335 postmortems
- Model: level 1 | use_model=True | brier n/a | history_rows 398 | cold=False
- Audit: 76652 records (31190 non-routine) | dominant SZ-047 (71% of non-routine) | chain=SEAMS(10, benign) | retrain_requests 179
- Liquidity: spoofy 67% of non-liquid cycles | feed errors 1
- Recent (48h lens): 6019 audit records | dominant LB-010 (33% of non-routine) | retrain_requests 8 | spoofy 67% (non-liquid)
...
- [WARN] **SD-004 audit trail dominated by one code**  -  LB-010 is 33% of 435 non-routine records (last 48h)  -  consequential dispositions are buried; rate-limit that emitter
