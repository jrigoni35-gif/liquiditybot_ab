...
- Window: 2026-07-10 07:53 UTC -> 2026-09-23 10:18 UTC (1802.41h, ~744 cycles)
- Equity (current capital epoch): $800.00 -> $766.81 (range $40.25) | 5 epochs lifetime, range $99,233.37 | realized PnL (post-close-fee) $-19.20 | fees (all legs) $33.59
- Activity: 4 open | 486 live labeled trades | 31718 candidates | 413 postmortems
- Model: level 0 | use_model=True | brier n/a | history_rows 486 | cold=False
- Audit: 90526 records (36683 non-routine) | dominant SZ-047 (61% of non-routine) | chain=SEAMS(63, benign) | retrain_requests 257
- Liquidity: spoofy 4% of non-liquid cycles | feed errors 1
- Recent (48h lens): 373 audit records | dominant EN-000 (18% of non-routine) | retrain_requests 8 | spoofy 4% (non-liquid)
