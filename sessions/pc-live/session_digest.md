...
- Window: 2026-07-10 07:53 UTC -> 2026-09-04 11:39 UTC (1347.77h, ~2120 cycles)
- Equity (current capital epoch): $800.00 -> $794.89 (range $16.78) | 5 epochs lifetime, range $99,209.90 | realized PnL (post-close-fee) $-0.55 | fees (all legs) $12.84
- Activity: 2 open | 407 live labeled trades | 23811 candidates | 342 postmortems
- Model: level 1 | use_model=True | brier n/a | history_rows 407 | cold=False
- Audit: 77038 records (31527 non-routine) | dominant SZ-047 (71% of non-routine) | chain=SEAMS(10, benign) | retrain_requests 184
- Liquidity: spoofy 68% of non-liquid cycles | feed errors 0
- Recent (48h lens): 503 audit records | dominant LB-010 (32% of non-routine) | retrain_requests 8 | spoofy 68% (non-liquid)
...
- [WARN] **SD-004 audit trail dominated by one code**  -  LB-010 is 32% of 436 non-routine records (last 48h)  -  consequential dispositions are buried; rate-limit that emitter
