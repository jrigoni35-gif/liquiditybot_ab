...
- Window: 2026-07-10 07:53 UTC -> 2026-08-13 17:55 UTC (826.04h, ~420 cycles)
- Equity: $25,000.00 -> $797.96 (range $99,208.70) | realized PnL $-1.25 | fees $1.23
- Activity: 3 open | 322 live labeled trades | 10099 candidates | 278 postmortems
- Model: level 0 | use_model=True | brier n/a | history_rows 322 | cold=True
- Audit: 44734 records (34860 non-routine) | dominant SZ-047 (64% of non-routine) | chain_ok=False (tamper=False, seams=6) | retrain_requests 107
...
- [WARN] **SD-004 audit trail dominated by one code**  -  SZ-047 is 64% of 34860 non-routine records  -  consequential dispositions are buried; rate-limit that emitter
