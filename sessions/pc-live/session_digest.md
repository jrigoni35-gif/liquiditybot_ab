...
- Window: 2026-07-10 07:53 UTC -> 2026-09-26 09:20 UTC (1873.45h, ~631 cycles)
- Equity (current capital epoch): $800.00 -> $762.69 (range $44.93) | 5 epochs lifetime, range $99,238.05 | realized PnL (post-close-fee) $-22.18 | fees (all legs) $37.16
- Activity: 5 open | 500 live labeled trades | 32824 candidates | 424 postmortems
- Model: level 0 | use_model=True | brier n/a | history_rows 500 | cold=False
- Audit: 91238 records (37264 non-routine) | dominant SZ-047 (60% of non-routine) | chain=SEAMS(63, benign) | retrain_requests 267
- Liquidity: spoofy 13% of non-liquid cycles | feed errors 0
- Recent (48h lens): 514 audit records | dominant LB-010 (21% of non-routine) | retrain_requests 7 | spoofy 13% (non-liquid)
