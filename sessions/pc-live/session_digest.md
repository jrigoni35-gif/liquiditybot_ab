...
- Window: 2026-07-10 07:53 UTC -> 2026-08-31 07:36 UTC (1247.72h, ~2886 cycles)
- Equity (current capital epoch): $800.00 -> $795.62 (range $12.30) | 5 epochs lifetime, range $99,208.70 | realized PnL (post-close-fee) $-0.24 | fees (all legs) $10.13
- Activity: 4 open | 387 live labeled trades | 20718 candidates | 324 postmortems
- Model: level 1 | use_model=True | brier n/a | history_rows 387 | cold=False
- Audit: 70451 records (30665 non-routine) | dominant SZ-047 (73% of non-routine) | chain=SEAMS(10, benign) | retrain_requests 169
- Liquidity: spoofy 66% of non-liquid cycles | feed errors 1373
- Recent (48h lens): 776 audit records | dominant LB-010 (30% of non-routine) | retrain_requests 8 | spoofy 66% (non-liquid)
