...
- Window: 2026-07-10 07:53 UTC -> 2026-09-07 17:43 UTC (1425.83h, ~1471 cycles)
- Equity (current capital epoch): $800.00 -> $791.10 (range $16.82) | 5 epochs lifetime, range $99,209.94 | realized PnL (post-close-fee) $-2.02 | fees (all legs) $14.89
- Activity: 5 open | 415 live labeled trades | 26444 candidates | 350 postmortems
- Model: level 0 | use_model=True | brier n/a | history_rows 415 | cold=False
- Audit: 85441 records (32675 non-routine) | dominant SZ-047 (68% of non-routine) | chain=SEAMS(16, benign) | retrain_requests 199
- Liquidity: spoofy 60% of non-liquid cycles | feed errors 1
- Recent (48h lens): 7592 audit records | dominant LB-010 (26% of non-routine) | retrain_requests 7 | spoofy 60% (non-liquid)
