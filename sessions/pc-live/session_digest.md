...
- Window: 2026-07-10 07:53 UTC -> 2026-09-03 00:38 UTC (1312.76h, ~1230 cycles)
- Equity (current capital epoch): $800.00 -> $790.43 (range $16.57) | 5 epochs lifetime, range $99,209.69 | realized PnL (post-close-fee) $-3.47 | fees (all legs) $11.67
- Activity: 3 open | 398 live labeled trades | 22688 candidates | 334 postmortems
- Model: level 1 | use_model=True | brier n/a | history_rows 398 | cold=False
- Audit: 76637 records (31175 non-routine) | dominant SZ-047 (71% of non-routine) | chain=SEAMS(10, benign) | retrain_requests 178
- Liquidity: spoofy 66% of non-liquid cycles | feed errors 1
- Recent (48h lens): 6027 audit records | dominant LB-010 (33% of non-routine) | retrain_requests 7 | spoofy 66% (non-liquid)
...
- [WARN] **SD-004 audit trail dominated by one code**  -  LB-010 is 33% of 443 non-routine records (last 48h)  -  consequential dispositions are buried; rate-limit that emitter
