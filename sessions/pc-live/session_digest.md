...
- Window: 2026-07-10 07:53 UTC -> 2026-09-06 17:42 UTC (1401.82h, ~1530 cycles)
- Equity (current capital epoch): $800.00 -> $793.64 (range $16.78) | 5 epochs lifetime, range $99,209.90 | realized PnL (post-close-fee) $-0.57 | fees (all legs) $13.92
- Activity: 2 open | 412 live labeled trades | 25441 candidates | 347 postmortems
- Model: level 0 | use_model=True | brier n/a | history_rows 412 | cold=False
- Audit: 82849 records (32500 non-routine) | dominant SZ-047 (68% of non-routine) | chain=SEAMS(16, benign) | retrain_requests 196
- Liquidity: spoofy 65% of non-liquid cycles | feed errors 2
- Recent (48h lens): 5789 audit records | dominant LB-010 (21% of non-routine) | retrain_requests 11 | spoofy 65% (non-liquid)
