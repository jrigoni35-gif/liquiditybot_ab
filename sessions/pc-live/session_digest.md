...
- Window: 2026-07-10 07:53 UTC -> 2026-09-04 03:39 UTC (1339.77h, ~1178 cycles)
- Equity (current capital epoch): $800.00 -> $794.56 (range $16.78) | 5 epochs lifetime, range $99,209.90 | realized PnL (post-close-fee) $-0.63 | fees (all legs) $12.64
- Activity: 2 open | 405 live labeled trades | 23693 candidates | 340 postmortems
- Model: level 1 | use_model=True | brier n/a | history_rows 405 | cold=False
- Audit: 76982 records (31475 non-routine) | dominant SZ-047 (71% of non-routine) | chain=SEAMS(10, benign) | retrain_requests 183
- Liquidity: spoofy 64% of non-liquid cycles | feed errors 0
- Recent (48h lens): 532 audit records | dominant LB-010 (34% of non-routine) | retrain_requests 8 | spoofy 64% (non-liquid)
...
- [WARN] **SD-004 audit trail dominated by one code**  -  LB-010 is 34% of 446 non-routine records (last 48h)  -  consequential dispositions are buried; rate-limit that emitter
