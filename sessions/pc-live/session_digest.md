...
- Window: 2026-07-10 07:53 UTC -> 2026-09-10 04:28 UTC (1484.58h, ~351 cycles)
- Equity (current capital epoch): $800.00 -> $789.70 (range $20.12) | 5 epochs lifetime, range $99,213.24 | realized PnL (post-close-fee) $-3.30 | fees (all legs) $16.74
- Activity: 5 open | 420 live labeled trades | 27301 candidates | 355 postmortems
- Model: level 0 | use_model=True | brier n/a | history_rows 420 | cold=False
- Audit: 85883 records (33024 non-routine) | dominant SZ-047 (67% of non-routine) | chain=SEAMS(18, benign) | retrain_requests 205
- Liquidity: spoofy 0% of non-liquid cycles | feed errors 6
- Recent (48h lens): 400 audit records | dominant LB-010 (35% of non-routine) | retrain_requests 4 | spoofy 0% (non-liquid)
...
- [WARN] **SD-004 audit trail dominated by one code**  -  LB-010 is 35% of 307 non-routine records (last 48h)  -  consequential dispositions are buried; rate-limit that emitter
