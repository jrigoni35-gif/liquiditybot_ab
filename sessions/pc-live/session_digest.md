...
- Window: 2026-07-10 07:53 UTC -> 2026-08-31 00:36 UTC (1240.71h, ~2071 cycles)
- Equity (current capital epoch): $800.00 -> $795.55 (range $12.30) | 5 epochs lifetime, range $99,208.70 | realized PnL (post-close-fee) $-0.24 | fees (all legs) $10.02
- Activity: 1 open | 387 live labeled trades | 20660 candidates | 324 postmortems
- Model: level 1 | use_model=True | brier n/a | history_rows 387 | cold=False
- Audit: 70405 records (30632 non-routine) | dominant SZ-047 (73% of non-routine) | chain=SEAMS(9, benign) | retrain_requests 168
- Liquidity: spoofy 68% of non-liquid cycles | feed errors 1
- Recent (48h lens): 823 audit records | dominant LB-010 (32% of non-routine) | retrain_requests 8 | spoofy 68% (non-liquid)
...
- [WARN] **SD-004 audit trail dominated by one code**  -  LB-010 is 32% of 612 non-routine records (last 48h)  -  consequential dispositions are buried; rate-limit that emitter
