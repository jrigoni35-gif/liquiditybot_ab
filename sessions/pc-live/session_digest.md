...
- Window: 2026-07-10 07:53 UTC -> 2026-09-02 22:38 UTC (1310.76h, ~995 cycles)
- Equity (current capital epoch): $800.00 -> $790.78 (range $16.38) | 5 epochs lifetime, range $99,209.50 | realized PnL (post-close-fee) $-3.19 | fees (all legs) $11.63
- Activity: 4 open | 397 live labeled trades | 22632 candidates | 334 postmortems
- Model: level 1 | use_model=True | brier n/a | history_rows 397 | cold=False
- Audit: 76620 records (31158 non-routine) | dominant SZ-047 (72% of non-routine) | chain=SEAMS(10, benign) | retrain_requests 178
- Liquidity: spoofy 68% of non-liquid cycles | feed errors 1
- Recent (48h lens): 6104 audit records | dominant LB-010 (32% of non-routine) | retrain_requests 7 | spoofy 68% (non-liquid)
...
- [WARN] **SD-004 audit trail dominated by one code**  -  LB-010 is 32% of 447 non-routine records (last 48h)  -  consequential dispositions are buried; rate-limit that emitter
