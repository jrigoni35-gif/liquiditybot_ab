...
- Window: 2026-07-10 07:53 UTC -> 2026-09-10 03:28 UTC (1483.58h, ~348 cycles)
- Equity (current capital epoch): $800.00 -> $789.32 (range $20.12) | 5 epochs lifetime, range $99,213.24 | realized PnL (post-close-fee) $-3.30 | fees (all legs) $16.74
- Activity: 5 open | 420 live labeled trades | 27298 candidates | 355 postmortems
- Model: level 0 | use_model=True | brier n/a | history_rows 420 | cold=False
- Audit: 85874 records (33015 non-routine) | dominant SZ-047 (68% of non-routine) | chain=SEAMS(18, benign) | retrain_requests 205
- Liquidity: spoofy 0% of non-liquid cycles | feed errors 6
- Recent (48h lens): 403 audit records | dominant LB-010 (35% of non-routine) | retrain_requests 4 | spoofy 0% (non-liquid)
...
- [WARN] **SD-004 audit trail dominated by one code**  -  LB-010 is 35% of 310 non-routine records (last 48h)  -  consequential dispositions are buried; rate-limit that emitter
