...
- Window: 2026-07-10 07:53 UTC -> 2026-08-16 20:27 UTC (900.57h, ~1560 cycles)
- Equity: $25,000.00 -> $799.09 (range $99,208.70) | realized PnL $0.29 | fees $2.64
- Activity: 3 open | 329 live labeled trades | 10404 candidates | 281 postmortems
- Model: level 0 | use_model=True | brier n/a | history_rows 329 | cold=True
- Audit: 45172 records (35236 non-routine) | dominant SZ-047 (63% of non-routine) | chain_ok=False (tamper=False, seams=6) | retrain_requests 116
- Liquidity: spoofy 58% of classified cycles | feed errors 214
...
- [WARN] **SD-004 audit trail dominated by one code**  -  SZ-047 is 63% of 35236 non-routine records  -  consequential dispositions are buried; rate-limit that emitter
