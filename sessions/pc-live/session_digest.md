...
- Window: 2026-07-10 07:53 UTC -> 2026-09-02 18:38 UTC (1306.75h, ~527 cycles)
- Equity (current capital epoch): $800.00 -> $791.20 (range $16.38) | 5 epochs lifetime, range $99,209.50 | realized PnL (post-close-fee) $-3.19 | fees (all legs) $11.60
- Activity: 3 open | 397 live labeled trades | 22580 candidates | 334 postmortems
- Model: level 1 | use_model=True | brier n/a | history_rows 397 | cold=False
- Audit: 76577 records (31129 non-routine) | dominant SZ-047 (72% of non-routine) | chain=SEAMS(10, benign) | retrain_requests 177
- Liquidity: spoofy 76% of non-liquid cycles | feed errors 1
- Recent (48h lens): 6099 audit records | dominant LB-010 (30% of non-routine) | retrain_requests 7 | spoofy 76% (non-liquid)
- Eras: current 9-16ec821e | signal_history exec_era: unavailable (signal_history.csv has no exec_era column (95 columns; label_era present=True, a label-definition axis, not the execution era)) | fills per exec_era: {'prestamp': 1024, '7-e7d5ca1a': 133, '9-16ec821e': 38, '8-ca55e2ba': 10, 'absent(stale-binary)': 6, '4-aeeaae36': 4} (1215 rows) | pooling_hazard=True (source fills.exec_era)
- RAW signal-file span (signal_ts, all 22977 rows on disk): 2026-07-13T12:35:47Z -> 2026-09-02T16:25:00Z (51.16d) - NOT the TRAINED corpus span: era exclusion + the label_era filter drop rows, so the span the champion is SCORED on is shorter. For that one (the MinBTL / Sharpe-SE denominator) run scripts/champion_skill_report.py --json -> corpus_span_days
