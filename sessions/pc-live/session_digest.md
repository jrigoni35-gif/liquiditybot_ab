...
- Window: 2026-07-10 07:53 UTC -> 2026-09-26 05:20 UTC (1869.45h, ~479 cycles)
- Equity (current capital epoch): $800.00 -> $762.73 (range $44.93) | 5 epochs lifetime, range $99,238.05 | realized PnL (post-close-fee) $-22.18 | fees (all legs) $37.14
- Activity: 4 open | 500 live labeled trades | 32810 candidates | 424 postmortems
- Model: level 0 | use_model=True | brier n/a | history_rows 500 | cold=False
- Audit: 91200 records (37226 non-routine) | dominant SZ-047 (60% of non-routine) | chain=SEAMS(63, benign) | retrain_requests 266
- Liquidity: spoofy 10% of non-liquid cycles | feed errors 0
- Recent (48h lens): 521 audit records | dominant LB-010 (20% of non-routine) | retrain_requests 6 | spoofy 10% (non-liquid)
