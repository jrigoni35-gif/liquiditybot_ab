...
- Window: 2026-07-10 07:53 UTC -> 2026-07-31 16:56 UTC (513.04h, ~1838 cycles)
- Equity: $25,000.00 -> $4,943.49 (range $99,208.70) | realized PnL $-30.21 | fees $51.41
- Activity: 1 open | 264 live labeled trades | 7143 candidates | 224 postmortems
- Model: level 0 | use_model=True | brier n/a | history_rows 264 | cold=True
- Audit: 27597 records (25005 non-routine) | dominant SZ-047 (89% of non-routine) | chain_ok=False (tamper=False, seams=5) | retrain_requests 60
- Liquidity: spoofy 53% of classified cycles | feed errors 3
...
- [WARN] **SD-004 audit trail dominated by one code**  -  SZ-047 is 89% of 25005 non-routine records  -  consequential dispositions are buried; rate-limit that emitter
