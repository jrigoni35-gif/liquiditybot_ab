...
- Window: 2026-07-10 07:53 UTC -> 2026-07-21 12:42 UTC (268.81h, ~1328 cycles)
- Equity: $25,000.00 -> $4,991.91 (range $99,208.70) | realized PnL $-4.18 | fees $9.24
- Activity: 3 open | 92 live labeled trades | 2183 candidates | 80 postmortems
- Model: level 2 | use_model=False | brier n/a | history_rows 92 | cold=True
- Audit: 1520 records (680 non-routine) | dominant OM-000 (33% of non-routine) | chain_ok=False (tamper=False, seams=2) | retrain_requests 26
...
- [WARN] **SD-004 audit trail dominated by one code**  -  OM-000 is 33% of 680 non-routine records  -  consequential dispositions are buried; rate-limit that emitter
