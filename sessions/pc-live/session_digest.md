...
- Window: 2026-07-10 07:53 UTC -> 2026-09-08 23:46 UTC (1455.88h, ~48 cycles)
- Equity (current capital epoch): $800.00 -> $788.42 (range $20.12) | 5 epochs lifetime, range $99,213.24 | realized PnL (post-close-fee) $-2.52 | fees (all legs) $16.16
- Activity: 5 open | 418 live labeled trades | 26983 candidates | 353 postmortems
- Model: level 0 | use_model=True | brier n/a | history_rows 418 | cold=False
- Audit: 85728 records (32926 non-routine) | dominant SZ-047 (68% of non-routine) | chain=SEAMS(17, benign) | retrain_requests 204
- Liquidity: spoofy 0% of non-liquid cycles | feed errors 0
- Recent (48h lens): 980 audit records | dominant LB-010 (24% of non-routine) | retrain_requests 8 | spoofy 0% (non-liquid)
...
- [INFO] **SD-010 audit writer seam(s)**  -  17 hash-valid concurrent-writer fork(s) in the chain - benign (no committed record altered); prevention: runner instance lock + one-bot mode
