...
- Window: 2026-07-10 07:53 UTC -> 2026-09-23 03:17 UTC (1795.4h, ~638 cycles)
- Equity (current capital epoch): $800.00 -> $768.53 (range $39.75) | 5 epochs lifetime, range $99,232.87 | realized PnL (post-close-fee) $-18.59 | fees (all legs) $32.84
- Activity: 5 open | 483 live labeled trades | 31594 candidates | 410 postmortems
- Model: level 0 | use_model=True | brier n/a | history_rows 483 | cold=False
- Audit: 90468 records (36634 non-routine) | dominant SZ-047 (61% of non-routine) | chain=SEAMS(63, benign) | retrain_requests 256
- Liquidity: spoofy 6% of non-liquid cycles | feed errors 1
- Recent (48h lens): 354 audit records | dominant EN-000 (19% of non-routine) | retrain_requests 8 | spoofy 6% (non-liquid)
- Eras: current 12-10d4d0c2 | signal_history exec_era: unavailable (signal_history.csv has no exec_era column (100 columns; label_era present=True, a label-definition axis, not the execution era)) | fills per exec_era: {'prestamp': 1030, '12-10d4d0c2': 144, '7-e7d5ca1a': 133, '9-16ec821e': 68, '8-ca55e2ba': 10, '10-a5acfe2d': 9, '11-6e584923': 8, '4-aeeaae36': 4} (1406 rows) | pooling_hazard=True (source fills.exec_era)
