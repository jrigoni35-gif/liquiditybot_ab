...
- Window: 2026-07-10 07:53 UTC -> 2026-09-22 11:17 UTC (1779.4h, ~37 cycles)
- Equity (current capital epoch): $800.00 -> $767.94 (range $39.09) | 5 epochs lifetime, range $99,232.21 | realized PnL (post-close-fee) $-18.48 | fees (all legs) $32.04
- Activity: 4 open | 482 live labeled trades | 31466 candidates | 407 postmortems
- Model: level 0 | use_model=True | brier n/a | history_rows 482 | cold=False
- Audit: 90308 records (36546 non-routine) | dominant SZ-047 (61% of non-routine) | chain=SEAMS(63, benign) | retrain_requests 253
- Liquidity: spoofy 2% of non-liquid cycles | feed errors 0
- Recent (48h lens): 331 audit records | dominant EN-000 (17% of non-routine) | retrain_requests 8 | spoofy 2% (non-liquid)
