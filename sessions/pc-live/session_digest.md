...
- Window: 2026-07-10 07:53 UTC -> 2026-09-20 02:15 UTC (1722.37h, ~916 cycles)
- Equity (current capital epoch): $800.00 -> $772.77 (range $35.96) | 5 epochs lifetime, range $99,229.08 | realized PnL (post-close-fee) $-14.22 | fees (all legs) $29.78
- Activity: 4 open | 470 live labeled trades | 30626 candidates | 397 postmortems
- Model: level 0 | use_model=True | brier n/a | history_rows 470 | cold=False
- Audit: 89929 records (36219 non-routine) | dominant SZ-047 (62% of non-routine) | chain=SEAMS(63, benign) | retrain_requests 244
- Liquidity: spoofy 12% of non-liquid cycles | feed errors 3
- Recent (48h lens): 514 audit records | dominant EN-000 (14% of non-routine) | retrain_requests 8 | spoofy 12% (non-liquid)
