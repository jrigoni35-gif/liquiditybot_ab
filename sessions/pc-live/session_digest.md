...
- Window: 2026-07-10 07:53 UTC -> 2026-09-04 01:39 UTC (1337.77h, ~942 cycles)
- Equity (current capital epoch): $800.00 -> $794.62 (range $16.78) | 5 epochs lifetime, range $99,209.90 | realized PnL (post-close-fee) $-0.32 | fees (all legs) $12.57
- Activity: 2 open | 404 live labeled trades | 23684 candidates | 339 postmortems
- Model: level 1 | use_model=True | brier n/a | history_rows 404 | cold=False
- Audit: 76944 records (31439 non-routine) | dominant SZ-047 (71% of non-routine) | chain=SEAMS(10, benign) | retrain_requests 182
- Liquidity: spoofy 62% of non-liquid cycles | feed errors 0
- Recent (48h lens): 529 audit records | dominant LB-010 (34% of non-routine) | retrain_requests 7 | spoofy 62% (non-liquid)
...
- [WARN] **SD-004 audit trail dominated by one code**  -  LB-010 is 34% of 431 non-routine records (last 48h)  -  consequential dispositions are buried; rate-limit that emitter
