...
- Window: 2026-07-10 07:53 UTC -> 2026-09-02 03:38 UTC (1291.75h, ~1728 cycles)
- Equity (current capital epoch): $800.00 -> $793.08 (range $14.33) | 5 epochs lifetime, range $99,208.70 | realized PnL (post-close-fee) $-2.14 | fees (all legs) $10.92
- Activity: 5 open | 392 live labeled trades | 22199 candidates | 328 postmortems
- Model: level 1 | use_model=True | brier n/a | history_rows 392 | cold=False
- Audit: 76450 records (31029 non-routine) | dominant SZ-047 (72% of non-routine) | chain=SEAMS(10, benign) | retrain_requests 175
- Liquidity: spoofy 62% of non-liquid cycles | feed errors 2
- Recent (48h lens): 6025 audit records | dominant LB-010 (26% of non-routine) | retrain_requests 7 | spoofy 62% (non-liquid)
- Eras: current 9-16ec821e | signal_history exec_era: unavailable (signal_history.csv has no exec_era column (95 columns; label_era present=True, a label-definition axis, not the execution era)) | fills per exec_era: {'prestamp': 1024, '7-e7d5ca1a': 133, '9-16ec821e': 30, '8-ca55e2ba': 10, 'absent(stale-binary)': 6, '4-aeeaae36': 4} (1207 rows) | pooling_hazard=True (source fills.exec_era)
- RAW signal-file span (signal_ts, all 22591 rows on disk): 2026-07-13T12:35:47Z -> 2026-09-02T01:46:11Z (50.55d) - NOT the TRAINED corpus span: era exclusion + the label_era filter drop rows, so the span the champion is SCORED on is shorter. For that one (the MinBTL / Sharpe-SE denominator) run scripts/champion_skill_report.py --json -> corpus_span_days
