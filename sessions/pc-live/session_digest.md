...
- Window: 2026-07-10 07:53 UTC -> 2026-09-21 05:16 UTC (1749.39h, ~1555 cycles)
- Equity (current capital epoch): $800.00 -> $768.11 (range $39.09) | 5 epochs lifetime, range $99,232.21 | realized PnL (post-close-fee) $-19.63 | fees (all legs) $31.13
- Activity: 2 open | 478 live labeled trades | 31212 candidates | 405 postmortems
- Model: level 0 | use_model=True | brier n/a | history_rows 478 | cold=False
- Audit: 90120 records (36386 non-routine) | dominant SZ-047 (61% of non-routine) | chain=SEAMS(63, benign) | retrain_requests 248
- Liquidity: spoofy 8% of non-liquid cycles | feed errors 5
- Recent (48h lens): 350 audit records | dominant EN-000 (18% of non-routine) | retrain_requests 8 | spoofy 8% (non-liquid)
