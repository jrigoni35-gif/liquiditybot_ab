...
- Window: 2026-07-10 07:53 UTC -> 2026-09-21 08:16 UTC (1752.39h, ~1684 cycles)
- Equity (current capital epoch): $800.00 -> $768.31 (range $39.09) | 5 epochs lifetime, range $99,232.21 | realized PnL (post-close-fee) $-19.63 | fees (all legs) $31.19
- Activity: 3 open | 478 live labeled trades | 31218 candidates | 405 postmortems
- Model: level 0 | use_model=True | brier n/a | history_rows 478 | cold=False
- Audit: 90141 records (36402 non-routine) | dominant SZ-047 (61% of non-routine) | chain=SEAMS(63, benign) | retrain_requests 249
- Liquidity: spoofy 8% of non-liquid cycles | feed errors 5
- Recent (48h lens): 334 audit records | dominant EN-000 (18% of non-routine) | retrain_requests 8 | spoofy 8% (non-liquid)
