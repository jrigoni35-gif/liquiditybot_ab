...
- Window: 2026-07-10 07:53 UTC -> 2026-09-02 15:38 UTC (1303.75h, ~175 cycles)
- Equity (current capital epoch): $800.00 -> $791.26 (range $16.33) | 5 epochs lifetime, range $99,209.45 | realized PnL (post-close-fee) $-3.19 | fees (all legs) $11.51
- Activity: 2 open | 397 live labeled trades | 22531 candidates | 334 postmortems
- Model: level 1 | use_model=True | brier n/a | history_rows 397 | cold=False
- Audit: 76557 records (31113 non-routine) | dominant SZ-047 (72% of non-routine) | chain=SEAMS(10, benign) | retrain_requests 177
- Liquidity: spoofy 79% of non-liquid cycles | feed errors 0
- Recent (48h lens): 6090 audit records | dominant LB-010 (29% of non-routine) | retrain_requests 7 | spoofy 79% (non-liquid)
- Eras: current 9-16ec821e | signal_history exec_era: unavailable (signal_history.csv has no exec_era column (95 columns; label_era present=True, a label-definition axis, not the execution era)) | fills per exec_era: {'prestamp': 1024, '7-e7d5ca1a': 133, '9-16ec821e': 37, '8-ca55e2ba': 10, 'absent(stale-binary)': 6, '4-aeeaae36': 4} (1214 rows) | pooling_hazard=True (source fills.exec_era)
- RAW signal-file span (signal_ts, all 22928 rows on disk): 2026-07-13T12:35:47Z -> 2026-09-02T14:35:00Z (51.08d) - NOT the TRAINED corpus span: era exclusion + the label_era filter drop rows, so the span the champion is SCORED on is shorter. For that one (the MinBTL / Sharpe-SE denominator) run scripts/champion_skill_report.py --json -> corpus_span_days
