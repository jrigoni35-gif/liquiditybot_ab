...
- Window: 2026-07-10 07:53 UTC -> 2026-09-10 15:29 UTC (1495.6h, ~640 cycles)
- Equity (current capital epoch): $800.00 -> $786.13 (range $21.90) | 5 epochs lifetime, range $99,215.02 | realized PnL (post-close-fee) $-3.78 | fees (all legs) $17.94
...
- Audit: 86055 records (33185 non-routine) | dominant SZ-047 (67% of non-routine) | chain=SEAMS(54, benign) | retrain_requests 207
- Liquidity: spoofy 1% of non-liquid cycles | feed errors 6
- Recent (48h lens): 418 audit records | dominant LB-010 (32% of non-routine) | retrain_requests 4 | spoofy 1% (non-liquid)
...
- [WARN] **SD-004 audit trail dominated by one code**  -  LB-010 is 32% of 346 non-routine records (last 48h)  -  consequential dispositions are buried; rate-limit that emitter
