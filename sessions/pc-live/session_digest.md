...
- Window: 2026-07-10 07:53 UTC -> 2026-09-12 09:31 UTC (1537.62h, ~1445 cycles)
- Equity (current capital epoch): $800.00 -> $787.55 (range $23.82) | 5 epochs lifetime, range $99,216.94 | realized PnL (post-close-fee) $-3.90 | fees (all legs) $20.29
...
- Audit: 87872 records (34906 non-routine) | dominant SZ-047 (64% of non-routine) | chain=SEAMS(59, benign) | retrain_requests 214
- Liquidity: spoofy 1% of non-liquid cycles | feed errors 8
- Recent (48h lens): 1882 audit records | dominant LB-010 (14% of non-routine) | retrain_requests 8 | spoofy 2% (non-liquid)
...
## Diagnostics
- [WARN] **SD-011 audit fork carries divergent payloads**  -  805 duplicated seq(s) whose rows disagree on (code, hash) - codes riding forks: {'LB-010': 308, 'LB-050': 201, 'CX-030': 198, 'SZ-051': 192, 'ML-070': 188, 'FW-050': 154, 'SZ-049': 117, 'FT-020': 114, 'CG-000': 107, 'CV-010': 83, 'OM-040': 77, 'ML-031': 75, 'CV-030': 50, 'OM-000': 46, 'ML-016': 23, 'ML-042': 22, 'ML-041': 22, 'ML-030': 19, 'CV-000': 19, 'PT-061': 16, 'SZ-052': 14, 'ML-032': 14, 'RT-010': 10, 'FT-010': 8, 'SZ-053': 7, 'LB-000': 7, 'ML-076': 6, 'ML-050': 6, 'SZ-047': 2, 'LB-021': 2, 'OM-080': 1, 'SZ-046': 1, 'OM-013': 1, 'ML-040': 1, 'LB-020': 1}; first examples: [{'seq': 503, 'codes': ['CG-000', 'RT-010'], 'ts': [1784239154.313, 1784239173.189]}, {'seq': 14864, 'codes': ['CG-000', 'SZ-047'], 'ts': [1785150021.206, 1785150150.318]}, {'seq': 14865, 'codes': ['FT-020', 'SZ-047'], 'ts': [1785150035.288, 1785150150.333]}]. Instruments consuming audit rows must not treat forked-seq rows as unique venue truth; find the writer (an unredirected script/harness - configure_audit exists for exactly this) and quarantine, never delete
