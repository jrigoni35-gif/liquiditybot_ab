...
- Window: 2026-07-10 07:53 UTC -> 2026-09-10 09:29 UTC (1489.6h, ~481 cycles)
- Equity (current capital epoch): $800.00 -> $789.40 (range $20.12) | 5 epochs lifetime, range $99,213.24 | realized PnL (post-close-fee) $-2.65 | fees (all legs) $17.10
- Activity: 5 open | 422 live labeled trades | 27328 candidates | 356 postmortems
- Model: level 0 | use_model=True | brier n/a | history_rows 422 | cold=False
- Audit: 85990 records (33126 non-routine) | dominant SZ-047 (67% of non-routine) | chain=SEAMS(54, benign) | retrain_requests 206
- Liquidity: spoofy 0% of non-liquid cycles | feed errors 6
- Recent (48h lens): 453 audit records | dominant LB-010 (32% of non-routine) | retrain_requests 4 | spoofy 0% (non-liquid)
...
- [WARN] **SD-004 audit trail dominated by one code**  -  LB-010 is 32% of 357 non-routine records (last 48h)  -  consequential dispositions are buried; rate-limit that emitter
