...
- Window: 2026-07-10 07:53 UTC -> 2026-09-07 09:42 UTC (1417.82h, ~867 cycles)
- Equity (current capital epoch): $800.00 -> $791.51 (range $16.78) | 5 epochs lifetime, range $99,209.90 | realized PnL (post-close-fee) $-1.20 | fees (all legs) $14.63
- Activity: 5 open | 414 live labeled trades | 26135 candidates | 349 postmortems
- Model: level 0 | use_model=True | brier n/a | history_rows 414 | cold=False
- Audit: 85393 records (32640 non-routine) | dominant SZ-047 (68% of non-routine) | chain=SEAMS(16, benign) | retrain_requests 198
- Liquidity: spoofy 69% of non-liquid cycles | feed errors 0
- Recent (48h lens): 7651 audit records | dominant LB-010 (26% of non-routine) | retrain_requests 11 | spoofy 69% (non-liquid)
- Eras: current 10-a5acfe2d | signal_history exec_era: unavailable (signal_history.csv has no exec_era column (95 columns; label_era present=True, a label-definition axis, not the execution era)) | fills per exec_era: {'prestamp': 1024, '7-e7d5ca1a': 133, '9-16ec821e': 68, '8-ca55e2ba': 10, '10-a5acfe2d': 9, 'absent(stale-binary)': 6, '4-aeeaae36': 4} (1254 rows) | pooling_hazard=True (source fills.exec_era)
- RAW signal-file span (signal_ts, all 26549 rows on disk): 2026-07-13T12:35:47Z -> 2026-09-07T09:00:00Z (55.85d) - NOT the TRAINED corpus span: era exclusion + the label_era filter drop rows, so the span the champion is SCORED on is shorter. For that one (the MinBTL / Sharpe-SE denominator) run scripts/champion_skill_report.py --json -> corpus_span_days
