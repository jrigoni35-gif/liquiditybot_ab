...
- Window: 2026-07-10 07:53 UTC -> 2026-09-03 16:39 UTC (1328.76h, ~3100 cycles)
- Equity (current capital epoch): $800.00 -> $794.91 (range $16.78) | 5 epochs lifetime, range $99,209.90 | realized PnL (post-close-fee) $-2.97 | fees (all legs) $12.29
- Activity: 2 open | 403 live labeled trades | 23588 candidates | 339 postmortems
- Model: level 1 | use_model=True | brier n/a | history_rows 403 | cold=False
- Audit: 76792 records (31313 non-routine) | dominant SZ-047 (71% of non-routine) | chain=SEAMS(10, benign) | retrain_requests 181
- Liquidity: spoofy 69% of non-liquid cycles | feed errors 2
- Recent (48h lens): 2842 audit records | dominant LB-010 (35% of non-routine) | retrain_requests 8 | spoofy 69% (non-liquid)
