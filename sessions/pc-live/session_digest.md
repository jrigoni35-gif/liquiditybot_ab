...
- Window: 2026-07-10 07:53 UTC -> 2026-09-20 13:16 UTC (1733.38h, ~1178 cycles)
- Equity (current capital epoch): $800.00 -> $770.42 (range $36.61) | 5 epochs lifetime, range $99,229.73 | realized PnL (post-close-fee) $-17.00 | fees (all legs) $30.38
- Activity: 3 open | 473 live labeled trades | 30837 candidates | 400 postmortems
- Model: level 0 | use_model=True | brier n/a | history_rows 473 | cold=False
- Audit: 90008 records (36278 non-routine) | dominant SZ-047 (61% of non-routine) | chain=SEAMS(63, benign) | retrain_requests 246
- Liquidity: spoofy 10% of non-liquid cycles | feed errors 4
- Recent (48h lens): 447 audit records | dominant EN-000 (18% of non-routine) | retrain_requests 8 | spoofy 10% (non-liquid)
