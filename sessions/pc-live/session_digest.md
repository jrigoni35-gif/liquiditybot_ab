...
- Window: 2026-07-10 07:53 UTC -> 2026-08-14 00:56 UTC (833.04h, ~1238 cycles)
- Equity: $25,000.00 -> $797.99 (range $99,208.70) | realized PnL $-1.25 | fees $1.26
- Activity: 4 open | 322 live labeled trades | 10142 candidates | 278 postmortems
- Model: level 0 | use_model=True | brier n/a | history_rows 322 | cold=True
- Audit: 44801 records (34913 non-routine) | dominant SZ-047 (64% of non-routine) | chain_ok=False (tamper=False, seams=6) | retrain_requests 108
...
- [WARN] **SD-004 audit trail dominated by one code**  -  SZ-047 is 64% of 34913 non-routine records  -  consequential dispositions are buried; rate-limit that emitter
