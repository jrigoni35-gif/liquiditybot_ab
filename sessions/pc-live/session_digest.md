...
- Window: 2026-07-10 07:53 UTC -> 2026-08-29 17:35 UTC (1209.7h, ~2095 cycles)
- Equity (current capital epoch): $800.00 -> $798.13 (range $10.12) | 5 epochs lifetime, range $99,208.70 | realized PnL (post-close-fee) $2.39 | fees (all legs) $8.30
- Activity: 5 open | 376 live labeled trades | 18926 candidates | 314 postmortems
- Model: level 0 | use_model=True | brier n/a | history_rows 376 | cold=False
- Audit: 69791 records (30213 non-routine) | dominant SZ-047 (74% of non-routine) | chain=SEAMS(9, benign) | retrain_requests 163
- Liquidity: spoofy 70% of non-liquid cycles | feed errors 0
- Recent (48h lens): 599 audit records | dominant LB-010 (38% of non-routine) | retrain_requests 8 | spoofy 70% (non-liquid)
