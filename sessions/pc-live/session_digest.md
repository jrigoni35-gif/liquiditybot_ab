...
- Window: 2026-07-10 07:53 UTC -> 2026-08-30 14:35 UTC (1230.71h, ~944 cycles)
- Equity (current capital epoch): $800.00 -> $798.85 (range $10.12) | 5 epochs lifetime, range $99,208.70 | realized PnL (post-close-fee) $1.72 | fees (all legs) $8.72
- Activity: 5 open | 378 live labeled trades | 19476 candidates | 316 postmortems
- Model: level 1 | use_model=True | brier n/a | history_rows 378 | cold=False
- Audit: 70204 records (30471 non-routine) | dominant SZ-047 (73% of non-routine) | chain=SEAMS(9, benign) | retrain_requests 166
- Liquidity: spoofy 73% of non-liquid cycles | feed errors 0
- Recent (48h lens): 743 audit records | dominant LB-010 (34% of non-routine) | retrain_requests 8 | spoofy 73% (non-liquid)
...
- [WARN] **SD-004 audit trail dominated by one code**  -  LB-010 is 34% of 566 non-routine records (last 48h)  -  consequential dispositions are buried; rate-limit that emitter
