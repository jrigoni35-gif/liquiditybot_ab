...
- Window: 2026-07-10 07:53 UTC -> 2026-08-29 16:35 UTC (1208.7h, ~1978 cycles)
- Equity (current capital epoch): $800.00 -> $798.18 (range $10.12) | 5 epochs lifetime, range $99,208.70 | realized PnL (post-close-fee) $2.39 | fees (all legs) $8.30
- Activity: 5 open | 376 live labeled trades | 18894 candidates | 314 postmortems
- Model: level 0 | use_model=True | brier n/a | history_rows 376 | cold=False
- Audit: 69778 records (30200 non-routine) | dominant SZ-047 (74% of non-routine) | chain=SEAMS(9, benign) | retrain_requests 162
- Liquidity: spoofy 72% of non-liquid cycles | feed errors 0
- Recent (48h lens): 591 audit records | dominant LB-010 (38% of non-routine) | retrain_requests 7 | spoofy 72% (non-liquid)
...
- [WARN] **SD-004 audit trail dominated by one code**  -  LB-010 is 38% of 526 non-routine records (last 48h)  -  consequential dispositions are buried; rate-limit that emitter
