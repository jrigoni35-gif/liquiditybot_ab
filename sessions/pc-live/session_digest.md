...
- Window: 2026-07-10 07:53 UTC -> 2026-09-03 22:39 UTC (1334.77h, ~589 cycles)
- Equity (current capital epoch): $800.00 -> $794.63 (range $16.78) | 5 epochs lifetime, range $99,209.90 | realized PnL (post-close-fee) $-0.32 | fees (all legs) $12.57
...
- Audit: 76900 records (31395 non-routine) | dominant SZ-047 (71% of non-routine) | chain=SEAMS(10, benign) | retrain_requests 182
- Liquidity: spoofy 60% of non-liquid cycles | feed errors 0
- Recent (48h lens): 1195 audit records | dominant LB-010 (34% of non-routine) | retrain_requests 8 | spoofy 60% (non-liquid)
...
- [WARN] **SD-004 audit trail dominated by one code**  -  LB-010 is 34% of 428 non-routine records (last 48h)  -  consequential dispositions are buried; rate-limit that emitter
