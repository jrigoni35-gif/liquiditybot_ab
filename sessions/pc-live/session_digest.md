...
- Window: 2026-07-10 07:53 UTC -> 2026-08-01 00:56 UTC (521.04h, ~2772 cycles)
- Equity: $25,000.00 -> $4,940.13 (range $99,208.70) | realized PnL $-32.74 | fees $54.29
- Activity: 1 open | 268 live labeled trades | 7403 candidates | 228 postmortems
- Model: level 0 | use_model=True | brier n/a | history_rows 268 | cold=True
- Audit: 27708 records (25097 non-routine) | dominant SZ-047 (89% of non-routine) | chain_ok=False (tamper=False, seams=5) | retrain_requests 61
...
- [WARN] **SD-004 audit trail dominated by one code**  -  SZ-047 is 89% of 25097 non-routine records  -  consequential dispositions are buried; rate-limit that emitter
