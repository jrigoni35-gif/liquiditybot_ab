...
- Window: 2026-07-10 07:53 UTC -> 2026-09-03 12:39 UTC (1324.76h, ~2633 cycles)
- Equity (current capital epoch): $800.00 -> $791.86 (range $16.78) | 5 epochs lifetime, range $99,209.90 | realized PnL (post-close-fee) $-3.83 | fees (all legs) $11.77
- Activity: 5 open | 399 live labeled trades | 23187 candidates | 336 postmortems
- Model: level 1 | use_model=True | brier n/a | history_rows 399 | cold=False
- Audit: 76742 records (31271 non-routine) | dominant SZ-047 (71% of non-routine) | chain=SEAMS(10, benign) | retrain_requests 180
- Liquidity: spoofy 68% of non-liquid cycles | feed errors 1
- Recent (48h lens): 4008 audit records | dominant LB-010 (35% of non-routine) | retrain_requests 8 | spoofy 68% (non-liquid)
