...
- Window: 2026-07-10 07:53 UTC -> 2026-09-10 00:28 UTC (1480.58h, ~159 cycles)
- Equity (current capital epoch): $800.00 -> $788.69 (range $20.12) | 5 epochs lifetime, range $99,213.24 | realized PnL (post-close-fee) $-3.29 | fees (all legs) $16.44
- Activity: 5 open | 419 live labeled trades | 27272 candidates | 354 postmortems
- Model: level 0 | use_model=True | brier n/a | history_rows 419 | cold=False
- Audit: 85836 records (32983 non-routine) | dominant SZ-047 (68% of non-routine) | chain=SEAMS(18, benign) | retrain_requests 205
- Liquidity: spoofy 0% of non-liquid cycles | feed errors 6
- Recent (48h lens): 378 audit records | dominant LB-010 (34% of non-routine) | retrain_requests 5 | spoofy 0% (non-liquid)
...
- [WARN] **SD-004 audit trail dominated by one code**  -  LB-010 is 34% of 291 non-routine records (last 48h)  -  consequential dispositions are buried; rate-limit that emitter
