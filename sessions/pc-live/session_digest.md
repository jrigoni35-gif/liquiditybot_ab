...
- Window: 2026-07-10 07:53 UTC -> 2026-09-16 19:32 UTC (1643.64h, ~700 cycles)
- Equity (current capital epoch): $800.00 -> $772.32 (range $34.94) | 5 epochs lifetime, range $99,228.06 | realized PnL (post-close-fee) $-16.92 | fees (all legs) $26.56
- Activity: 1 open | 456 live labeled trades | 29571 candidates | 385 postmortems
- Model: level 0 | use_model=True | brier n/a | history_rows 456 | cold=False
- Audit: 89188 records (35661 non-routine) | dominant SZ-047 (62% of non-routine) | chain=SEAMS(61, benign) | retrain_requests 231
- Liquidity: spoofy 2% of non-liquid cycles | feed errors 4
- Recent (48h lens): 543 audit records | dominant LB-010 (19% of non-routine) | retrain_requests 7 | spoofy 2% (non-liquid)
