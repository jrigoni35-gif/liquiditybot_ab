...
- Window: 2026-07-10 07:53 UTC -> 2026-09-26 01:20 UTC (1865.44h, ~332 cycles)
- Equity (current capital epoch): $800.00 -> $762.76 (range $44.93) | 5 epochs lifetime, range $99,238.05 | realized PnL (post-close-fee) $-22.18 | fees (all legs) $37.05
- Activity: 3 open | 500 live labeled trades | 32755 candidates | 424 postmortems
- Model: level 0 | use_model=True | brier n/a | history_rows 500 | cold=False
- Audit: 91162 records (37194 non-routine) | dominant SZ-047 (60% of non-routine) | chain=SEAMS(63, benign) | retrain_requests 266
- Liquidity: spoofy 7% of non-liquid cycles | feed errors 0
- Recent (48h lens): 499 audit records | dominant LB-010 (18% of non-routine) | retrain_requests 7 | spoofy 7% (non-liquid)
