...
- Window: 2026-07-10 07:53 UTC -> 2026-07-21 15:42 UTC (271.81h, ~1664 cycles)
- Equity: $25,000.00 -> $4,991.66 (range $99,208.70) | realized PnL $-4.51 | fees $9.46
- Activity: 0 open | 95 live labeled trades | 2210 candidates | 83 postmortems
- Model: level 0 | use_model=True | brier n/a | history_rows 95 | cold=True
- Audit: 1591 records (707 non-routine) | dominant OM-000 (32% of non-routine) | chain_ok=False (tamper=False, seams=2) | retrain_requests 27
...
- [WARN] **SD-004 audit trail dominated by one code**  -  OM-000 is 32% of 707 non-routine records  -  consequential dispositions are buried; rate-limit that emitter
