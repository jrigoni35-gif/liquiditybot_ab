...
- Window: 2026-07-10 07:53 UTC -> 2026-09-08 21:44 UTC (1453.84h, ~1471 cycles)
- Equity (current capital epoch): $800.00 -> $788.52 (range $20.12) | 5 epochs lifetime, range $99,213.24 | realized PnL (post-close-fee) $-2.52 | fees (all legs) $16.16
- Activity: 5 open | 418 live labeled trades | 26954 candidates | 353 postmortems
- Model: level 0 | use_model=True | brier n/a | history_rows 418 | cold=False
- Audit: 85709 records (32907 non-routine) | dominant SZ-047 (68% of non-routine) | chain=SEAMS(16, benign) | retrain_requests 204
- Liquidity: spoofy 44% of non-liquid cycles | feed errors 3
- Recent (48h lens): 1621 audit records | dominant LB-010 (24% of non-routine) | retrain_requests 8 | spoofy 44% (non-liquid)
