...
- Window: 2026-07-10 07:53 UTC -> 2026-08-18 08:25 UTC (936.52h, ~1414 cycles)
- Equity: $25,000.00 -> $799.14 (range $99,208.70) | realized PnL $0.59 | fees $3.37
- Activity: 5 open | 333 live labeled trades | 10785 candidates | 283 postmortems
- Model: level 0 | use_model=True | brier n/a | history_rows 333 | cold=True
- Audit: 45565 records (35508 non-routine) | dominant SZ-047 (63% of non-routine) | chain_ok=False (tamper=False, seams=8) | retrain_requests 120
- Liquidity: spoofy 69% of classified cycles | feed errors 5
...
- [WARN] **SD-004 audit trail dominated by one code**  -  SZ-047 is 63% of 35508 non-routine records  -  consequential dispositions are buried; rate-limit that emitter
