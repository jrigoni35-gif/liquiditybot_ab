...
- Window: 2026-07-10 07:53 UTC -> 2026-09-04 05:39 UTC (1341.77h, ~1413 cycles)
- Equity (current capital epoch): $800.00 -> $794.64 (range $16.78) | 5 epochs lifetime, range $99,209.90 | realized PnL (post-close-fee) $-0.63 | fees (all legs) $12.64
- Activity: 2 open | 405 live labeled trades | 23702 candidates | 340 postmortems
- Model: level 1 | use_model=True | brier n/a | history_rows 405 | cold=False
- Audit: 77008 records (31501 non-routine) | dominant SZ-047 (71% of non-routine) | chain=SEAMS(10, benign) | retrain_requests 183
- Liquidity: spoofy 67% of non-liquid cycles | feed errors 0
- Recent (48h lens): 547 audit records | dominant LB-010 (32% of non-routine) | retrain_requests 8 | spoofy 67% (non-liquid)
...
- [WARN] **SD-004 audit trail dominated by one code**  -  LB-010 is 32% of 463 non-routine records (last 48h)  -  consequential dispositions are buried; rate-limit that emitter
