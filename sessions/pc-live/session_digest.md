...
- Window: 2026-07-10 07:53 UTC -> 2026-08-30 01:35 UTC (1217.7h, ~3037 cycles)
- Equity (current capital epoch): $800.00 -> $798.19 (range $10.12) | 5 epochs lifetime, range $99,208.70 | realized PnL (post-close-fee) $1.94 | fees (all legs) $8.51
- Activity: 5 open | 377 live labeled trades | 19045 candidates | 315 postmortems
- Model: level 1 | use_model=True | brier n/a | history_rows 377 | cold=False
- Audit: 69893 records (30304 non-routine) | dominant SZ-047 (74% of non-routine) | chain=SEAMS(9, benign) | retrain_requests 164
- Liquidity: spoofy 72% of non-liquid cycles | feed errors 0
- Recent (48h lens): 622 audit records | dominant LB-010 (35% of non-routine) | retrain_requests 8 | spoofy 72% (non-liquid)
