...
- Window: 2026-07-10 07:53 UTC -> 2026-07-31 09:55 UTC (506.04h, ~1054 cycles)
- Equity: $25,000.00 -> $4,954.49 (range $99,208.70) | realized PnL $-21.74 | fees $42.10
- Activity: 5 open | 256 live labeled trades | 6826 candidates | 216 postmortems
- Model: level 0 | use_model=True | brier n/a | history_rows 256 | cold=True
- Audit: 27512 records (24929 non-routine) | dominant SZ-047 (89% of non-routine) | chain_ok=False (tamper=False, seams=5) | retrain_requests 59
...
- [WARN] **SD-004 audit trail dominated by one code**  -  SZ-047 is 89% of 24929 non-routine records  -  consequential dispositions are buried; rate-limit that emitter
