...
- Window: 2026-07-10 07:53 UTC -> 2026-07-24 18:44 UTC (346.85h, ~1653 cycles)
- Equity: $25,000.00 -> $4,965.86 (range $99,208.70) | realized PnL $-19.90 | fees $34.54
- Activity: 0 open | 240 live labeled trades | 3827 candidates | 204 postmortems
- Model: level 2 | use_model=False | brier n/a | history_rows 240 | cold=True
- Audit: 7229 records (4671 non-routine) | dominant SZ-047 (59% of non-routine) | chain_ok=False (tamper=False, seams=2) | retrain_requests 36
...
- [WARN] **SD-004 audit trail dominated by one code**  -  SZ-047 is 59% of 4671 non-routine records  -  consequential dispositions are buried; rate-limit that emitter
