# Overfit audit — 2026-09-10 20:05 UTC

Dataset: live history (17556 rows)
...
- **PASS** shuffle: destroyed labels learn nothing OOF — mean_auc=0.496 z=1.5 (limit 3.0)
...
- **PASS** dof: not starved (>=10 rows per feature) — rows/feature=274.3 (17556 rows / 64 features)
- **INFO** dof COVERAGE — dead-feature scan UNINFORMATIVE: the fitted GBT consulted only 22/64 features (42 of the 54 'dead' were never split on at all). Read dead_feature_frac as the model's blindness, not the features' deadness; the clustered-MDA report (scripts/interpret_report.py) is the honest ranking.
...
- **INFO** regime[bull_quiet] oof — oof_n=3311 auc=0.571 (pooled 0.551, delta_auc=+0.019) brier=0.2511 (pooled 0.2428, delta_brier=+0.0082)
...
- **INFO** regime[bull_vol] oof — oof_n=1758 auc=0.641 (pooled 0.551, delta_auc=+0.089) brier=0.2323 (pooled 0.2428, delta_brier=-0.0105)
- **INFO** regime[range] — n=10903 (candidate=10580 live=323) base_rate=0.298
- **INFO** regime[range] oof — oof_n=3514 auc=0.612 (pooled 0.551, delta_auc=+0.060) brier=0.2385 (pooled 0.2428, delta_brier=-0.0043)
...
- **INFO** regime[crisis] oof — oof_n=3770 auc=0.632 (pooled 0.551, delta_auc=+0.081) brier=0.2387 (pooled 0.2428, delta_brier=-0.0041)
- **INFO** regime[unknown] — n=0 — absent from corpus
- **INFO** learning curve caveat — each point refits gbt on a chronological PREFIX of the corpus (time-purged OOF, deployed protocol) — points are the same statistic across sizes, but none is OF-1's own pooled number
- **INFO** lc[n=4389] — oof_n=3655 auc=0.642 brier=0.2324
- **INFO** lc[n=7022] — oof_n=5850 auc=0.533 brier=0.2596
- **INFO** lc[n=9656] — oof_n=8045 auc=0.533 brier=0.2654
- **INFO** lc[n=12289] — oof_n=10240 auc=0.496 brier=0.2732
- **INFO** lc[n=14923] — oof_n=12435 auc=0.593 brier=0.2466
- **INFO** lc[n=17556] — oof_n=14630 auc=0.610 brier=0.2428
...
- **INFO** extras[equity_risk_z] — at-neutral share 25.2% (n=17556) — feed live for most of the corpus; consider the missingness-indicator column (schema bump) if this family earns model importance
- **INFO** extras[opt_pcr_z] — at-neutral share 25.5% (n=17556) — feed live for most of the corpus; consider the missingness-indicator column (schema bump) if this family earns model importance
- **INFO** extras[opt_oi_pcr_z] — at-neutral share 25.5% (n=17556) — feed live for most of the corpus; consider the missingness-indicator column (schema bump) if this family earns model importance
- **INFO** extras[dominance_delta] — at-neutral share 2.3% (n=17556) — feed live for most of the corpus; consider the missingness-indicator column (schema bump) if this family earns model importance
- **INFO** extras[sent_fear] — at-neutral share 100.0% (n=17556) — feed effectively dark corpus-wide (dead column)
- **INFO** extras[fear_greed] — at-neutral share 0.0% (n=17556) — feed live for most of the corpus; consider the missingness-indicator column (schema bump) if this family earns model importance

4 passed, 0 failed (109s)

Corpus: live history (17556 rows)
