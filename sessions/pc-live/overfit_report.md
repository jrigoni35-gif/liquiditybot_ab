# Overfit audit — 2026-09-10 23:15 UTC

Dataset: live history (17562 rows)
...
- **INFO** null-floor[logistic] — OOF Brier 0.2665 vs base-rate constant 0.2443 (base=0.425, n=14635) — LOSES TO THE NULL: negative skill, sizing on this model's p(win) is worse than sizing on the base rate
- **INFO** null-floor[gbt] — OOF Brier 0.2428 vs base-rate constant 0.2443 (base=0.425, n=14635) — BEATS the null
- **INFO** null-floor[mlp] — OOF Brier 0.3008 vs base-rate constant 0.2443 (base=0.425, n=14635) — LOSES TO THE NULL: negative skill, sizing on this model's p(win) is worse than sizing on the base rate
...
- **PASS** dof: not starved (>=10 rows per feature) — rows/feature=274.4 (17562 rows / 64 features)
- **INFO** dof COVERAGE — dead-feature scan UNINFORMATIVE: the fitted GBT consulted only 21/64 features (43 of the 56 'dead' were never split on at all). Read dead_feature_frac as the model's blindness, not the features' deadness; the clustered-MDA report (scripts/interpret_report.py) is the honest ranking.
...
- **INFO** dof note — low/zero-importance: ['hour_sin', 'opt_iv_skew', 'va_pos', 'sigma_bar_pct', 'vol_percentile', 'equity_risk_z'] ...
...
- **INFO** regime[bull_quiet] — n=3898 (candidate=3872 live=26) base_rate=0.381
...
- **INFO** regime[bull_quiet] oof — oof_n=3313 auc=0.571 (pooled 0.551, delta_auc=+0.020) brier=0.2510 (pooled 0.2428, delta_brier=+0.0082)
...
- **INFO** regime[bull_vol] oof — oof_n=1759 auc=0.642 (pooled 0.551, delta_auc=+0.090) brier=0.2321 (pooled 0.2428, delta_brier=-0.0107)
- **INFO** regime[range] — n=10906 (candidate=10583 live=323) base_rate=0.298
- **INFO** regime[range] oof — oof_n=3517 auc=0.611 (pooled 0.551, delta_auc=+0.060) brier=0.2386 (pooled 0.2428, delta_brier=-0.0042)
- **INFO** regime[bear] — n=7272 (candidate=7209 live=63) base_rate=0.341
- **INFO** regime[bear] oof — oof_n=2277 auc=0.567 (pooled 0.551, delta_auc=+0.016) brier=0.2525 (pooled 0.2428, delta_brier=+0.0096)
...
- **INFO** regime[crisis] oof — oof_n=3769 auc=0.632 (pooled 0.551, delta_auc=+0.081) brier=0.2387 (pooled 0.2428, delta_brier=-0.0041)
- **INFO** regime[unknown] — n=0 — absent from corpus
- **INFO** learning curve caveat — each point refits gbt on a chronological PREFIX of the corpus (time-purged OOF, deployed protocol) — points are the same statistic across sizes, but none is OF-1's own pooled number
- **INFO** lc[n=4390] — oof_n=3655 auc=0.642 brier=0.2324
- **INFO** lc[n=7025] — oof_n=5850 auc=0.533 brier=0.2596
- **INFO** lc[n=9659] — oof_n=8045 auc=0.533 brier=0.2654
- **INFO** lc[n=12293] — oof_n=10240 auc=0.496 brier=0.2732
- **INFO** lc[n=14928] — oof_n=12440 auc=0.616 brier=0.2437
- **INFO** lc[n=17562] — oof_n=14635 auc=0.610 brier=0.2428
...
- **INFO** extras[equity_risk_z] — at-neutral share 25.2% (n=17562) — feed live for most of the corpus; consider the missingness-indicator column (schema bump) if this family earns model importance
- **INFO** extras[opt_pcr_z] — at-neutral share 25.5% (n=17562) — feed live for most of the corpus; consider the missingness-indicator column (schema bump) if this family earns model importance
- **INFO** extras[opt_oi_pcr_z] — at-neutral share 25.5% (n=17562) — feed live for most of the corpus; consider the missingness-indicator column (schema bump) if this family earns model importance
- **INFO** extras[dominance_delta] — at-neutral share 2.3% (n=17562) — feed live for most of the corpus; consider the missingness-indicator column (schema bump) if this family earns model importance
- **INFO** extras[sent_fear] — at-neutral share 100.0% (n=17562) — feed effectively dark corpus-wide (dead column)
- **INFO** extras[fear_greed] — at-neutral share 0.0% (n=17562) — feed live for most of the corpus; consider the missingness-indicator column (schema bump) if this family earns model importance

4 passed, 0 failed (116s)

Corpus: live history (17562 rows)
