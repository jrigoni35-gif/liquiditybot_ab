...
- Window: 2026-07-13 10:33 UTC -> 2026-07-16 23:40 UTC (85.12h, ~832 cycles)
- Equity: $800.00 -> $4,999.71 (range $4,201.35) | realized PnL $0.00 | fees $0.00
- Activity: 5 open | 19 live labeled trades | 374 candidates | 8 postmortems
- Model: level 0 | use_model=True | brier n/a | history_rows 19 | cold=True
- Audit: 523 records (159 non-routine) | dominant CG-000 (45% of non-routine) | chain_ok=False | retrain_requests 3
- Liquidity: spoofy 68% of classified cycles | feed errors 14
...
- [WARN] **SD-004 audit trail dominated by one code**  -  CG-000 is 45% of 159 non-routine records  -  consequential dispositions are buried; rate-limit that emitter
