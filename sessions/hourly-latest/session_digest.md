...
- Window: 2026-07-13 10:33 UTC -> 2026-07-17 17:47 UTC (103.23h, ~1569 cycles)
- Equity: $800.00 -> $4,996.58 (range $4,201.35) | realized PnL $-3.42 | fees $2.07
- Activity: 0 open | 35 live labeled trades | 486 candidates | 15 postmortems
- Model: level 0 | use_model=True | brier n/a | history_rows 35 | cold=True
- Audit: 682 records (263 non-routine) | dominant CG-000 (40% of non-routine) | chain_ok=False | retrain_requests 3
- Liquidity: spoofy 48% of classified cycles | feed errors 70
...
- [WARN] **SD-004 audit trail dominated by one code**  -  CG-000 is 40% of 263 non-routine records  -  consequential dispositions are buried; rate-limit that emitter
