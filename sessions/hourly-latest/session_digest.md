...
- Window: 2026-07-13 10:33 UTC -> 2026-07-17 10:17 UTC (95.75h, ~1256 cycles)
- Equity: $800.00 -> $4,998.32 (range $4,201.35) | realized PnL $-1.65 | fees $0.78
- Activity: 4 open | 25 live labeled trades | 444 candidates | 9 postmortems
- Model: level 0 | use_model=True | brier n/a | history_rows 25 | cold=True
- Audit: 590 records (198 non-routine) | dominant CG-000 (42% of non-routine) | chain_ok=False | retrain_requests 3
- Liquidity: spoofy 62% of classified cycles | feed errors 31
...
- [WARN] **SD-004 audit trail dominated by one code**  -  CG-000 is 42% of 198 non-routine records  -  consequential dispositions are buried; rate-limit that emitter
