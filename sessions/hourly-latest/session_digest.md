...
- Window: 2026-07-13 10:33 UTC -> 2026-07-16 20:21 UTC (81.8h, ~637 cycles)
- Equity: $800.00 -> $800.60 (range $2.25) | realized PnL $0.66 | fees $2.33
- Activity: 5 open | 19 live labeled trades | 350 candidates | 8 postmortems
- Model: level 0 | use_model=True | brier n/a | history_rows 19 | cold=True
- Audit: 506 records (142 non-routine) | dominant CG-000 (44% of non-routine) | chain_ok=False | retrain_requests 3
...
- [WARN] **SD-004 audit trail dominated by one code**  -  CG-000 is 44% of 142 non-routine records  -  consequential dispositions are buried; rate-limit that emitter
