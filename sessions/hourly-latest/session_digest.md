...
- Window: 2026-07-13 10:33 UTC -> 2026-07-17 03:51 UTC (89.31h, ~1201 cycles)
- Equity: $800.00 -> $4,999.12 (range $4,201.35) | realized PnL $-0.31 | fees $0.45
- Activity: 5 open | 22 live labeled trades | 421 candidates | 9 postmortems
- Model: level 0 | use_model=True | brier n/a | history_rows 22 | cold=True
- Audit: 572 records (182 non-routine) | dominant CG-000 (43% of non-routine) | chain_ok=False | retrain_requests 3
- Liquidity: spoofy 66% of classified cycles | feed errors 22
...
- [WARN] **SD-004 audit trail dominated by one code**  -  CG-000 is 43% of 182 non-routine records  -  consequential dispositions are buried; rate-limit that emitter
