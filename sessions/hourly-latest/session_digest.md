...
- Window: 2026-07-13 10:33 UTC -> 2026-07-15 04:54 UTC (42.35h, ~1995 cycles)
- Equity: $800.00 -> $800.66 (range $2.25) | realized PnL $0.66 | fees $2.10
- Activity: 0 open | 19 live labeled trades | 140 candidates | 8 postmortems
- Model: level 0 | use_model=True | brier n/a | history_rows 19 | cold=True
- Audit: 246 records (85 non-routine) | dominant OM-000 (66% of non-routine) | chain_ok=False | retrain_requests 2
- Liquidity: spoofy 79% of classified cycles | feed errors 1944
...
- [WARN] **SD-004 audit trail dominated by one code**  -  OM-000 is 66% of 85 non-routine records  -  consequential dispositions are buried; rate-limit that emitter
