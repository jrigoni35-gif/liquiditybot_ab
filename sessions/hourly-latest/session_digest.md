...
- Window: 2026-07-13 10:33 UTC -> 2026-07-17 12:05 UTC (97.54h, ~1387 cycles)
- Equity: $800.00 -> $4,998.41 (range $4,201.35) | realized PnL $-1.57 | fees $1.23
- Activity: 4 open | 28 live labeled trades | 465 candidates | 12 postmortems
- Model: level 0 | use_model=True | brier n/a | history_rows 28 | cold=True
- Audit: 635 records (220 non-routine) | dominant CG-000 (41% of non-routine) | chain_ok=False | retrain_requests 3
- Liquidity: spoofy 54% of classified cycles | feed errors 38
...
- [WARN] **SD-004 audit trail dominated by one code**  -  CG-000 is 41% of 220 non-routine records  -  consequential dispositions are buried; rate-limit that emitter
