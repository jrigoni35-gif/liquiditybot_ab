...
- Window: 2026-07-13 10:33 UTC -> 2026-07-17 10:58 UTC (96.43h, ~1325 cycles)
- Equity: $800.00 -> $4,998.30 (range $4,201.35) | realized PnL $-1.57 | fees $1.23
- Activity: 4 open | 28 live labeled trades | 462 candidates | 12 postmortems
- Model: level 0 | use_model=True | brier n/a | history_rows 28 | cold=True
- Audit: 614 records (210 non-routine) | dominant CG-000 (40% of non-routine) | chain_ok=False | retrain_requests 3
- Liquidity: spoofy 58% of classified cycles | feed errors 33
...
- [WARN] **SD-004 audit trail dominated by one code**  -  CG-000 is 40% of 210 non-routine records  -  consequential dispositions are buried; rate-limit that emitter
