...
- Window: 2026-07-13 10:33 UTC -> 2026-07-15 16:01 UTC (53.48h, ~2597 cycles)
- Equity: $800.00 -> $800.66 (range $2.25) | realized PnL $0.66 | fees $2.10
- Activity: 0 open | 19 live labeled trades | 249 candidates | 8 postmortems
- Model: level 0 | use_model=True | brier n/a | history_rows 19 | cold=True
- Audit: 297 records (94 non-routine) | dominant OM-000 (60% of non-routine) | chain_ok=False | retrain_requests 2
- Liquidity: spoofy 77% of classified cycles | feed errors 1945
...
- [WARN] **SD-004 audit trail dominated by one code**  -  OM-000 is 60% of 94 non-routine records  -  consequential dispositions are buried; rate-limit that emitter
