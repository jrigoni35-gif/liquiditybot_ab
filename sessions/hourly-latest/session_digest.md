...
- Window: 2026-07-13 10:33 UTC -> 2026-07-16 22:37 UTC (84.07h, ~814 cycles)
- Equity: $800.00 -> $5,000.07 (range $4,201.35) | realized PnL $0.00 | fees $0.00
- Activity: 5 open | 19 live labeled trades | 359 candidates | 8 postmortems
- Model: level 0 | use_model=True | brier n/a | history_rows 19 | cold=True
- Audit: 519 records (155 non-routine) | dominant CG-000 (44% of non-routine) | chain_ok=False | retrain_requests 3
...
- [WARN] **SD-004 audit trail dominated by one code**  -  CG-000 is 44% of 155 non-routine records  -  consequential dispositions are buried; rate-limit that emitter
