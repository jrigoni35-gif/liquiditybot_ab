...
- Window: 2026-07-13 10:33 UTC -> 2026-07-17 01:32 UTC (86.99h, ~993 cycles)
- Equity: $800.00 -> $4,999.64 (range $4,201.35) | realized PnL $0.08 | fees $0.18
- Activity: 4 open | 21 live labeled trades | 397 candidates | 8 postmortems
- Model: level 0 | use_model=True | brier n/a | history_rows 21 | cold=True
- Audit: 557 records (173 non-routine) | dominant CG-000 (43% of non-routine) | chain_ok=False | retrain_requests 3
- Liquidity: spoofy 67% of classified cycles | feed errors 19
...
- [WARN] **SD-004 audit trail dominated by one code**  -  CG-000 is 43% of 173 non-routine records  -  consequential dispositions are buried; rate-limit that emitter
