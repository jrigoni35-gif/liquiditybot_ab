...
- Window: 2026-07-13 10:33 UTC -> 2026-07-16 23:52 UTC (85.33h, ~856 cycles)
- Equity: $800.00 -> $4,999.68 (range $4,201.35) | realized PnL $0.03 | fees $0.07
- Activity: 4 open | 20 live labeled trades | 379 candidates | 8 postmortems
- Model: level 0 | use_model=True | brier n/a | history_rows 20 | cold=True
- Audit: 532 records (163 non-routine) | dominant CG-000 (44% of non-routine) | chain_ok=False | retrain_requests 3
...
- [WARN] **SD-004 audit trail dominated by one code**  -  CG-000 is 44% of 163 non-routine records  -  consequential dispositions are buried; rate-limit that emitter
