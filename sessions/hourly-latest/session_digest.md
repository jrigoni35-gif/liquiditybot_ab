...
- Window: 2026-07-13 10:33 UTC -> 2026-07-16 11:34 UTC (73.03h, ~15 cycles)
...
- Audit: 411 records (118 non-routine) | dominant OM-000 (48% of non-routine) | chain_ok=False | retrain_requests 3
- Liquidity: spoofy 97% of classified cycles | feed errors 1
...
- [WARN] **SD-003 liquidity vetoed feed-wide**  -  liquidity classified 'spoofy' on 97% of classified cycles, which suppresses sizing/taker on every asset. On a near-zero-spread feed this is likely a classifier miscalibration, not real spoofing  -  inspect the book source
- [WARN] **SD-004 audit trail dominated by one code**  -  OM-000 is 48% of 118 non-routine records  -  consequential dispositions are buried; rate-limit that emitter
