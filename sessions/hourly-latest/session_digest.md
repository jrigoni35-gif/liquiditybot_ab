...
- Window: 2026-07-13 10:33 UTC -> 2026-07-17 00:34 UTC (86.02h, ~933 cycles)
- Equity: $800.00 -> $4,999.47 (range $4,201.35) | realized PnL $0.03 | fees $0.11
- Activity: 5 open | 20 live labeled trades | 388 candidates | 8 postmortems
- Model: level 0 | use_model=True | brier n/a | history_rows 20 | cold=True
- Audit: 538 records (168 non-routine) | dominant CG-000 (44% of non-routine) | chain_ok=False | retrain_requests 3
...
- [WARN] **SD-004 audit trail dominated by one code**  -  CG-000 is 44% of 168 non-routine records  -  consequential dispositions are buried; rate-limit that emitter
