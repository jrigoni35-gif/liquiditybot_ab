...
- Window: 2026-07-13 10:33 UTC -> 2026-07-16 10:31 UTC (71.98h, ~3499 cycles)
- Equity: $800.00 -> $800.66 (range $2.25) | realized PnL $0.66 | fees $2.10
- Activity: 0 open | 19 live labeled trades | 337 candidates | 8 postmortems
- Model: level 0 | use_model=True | brier n/a | history_rows 19 | cold=True
- Audit: 405 records (116 non-routine) | dominant OM-000 (48% of non-routine) | chain_ok=False | retrain_requests 3
- Liquidity: spoofy 76% of classified cycles | feed errors 1963
...
- [WARN] **SD-004 audit trail dominated by one code**  -  OM-000 is 48% of 116 non-routine records  -  consequential dispositions are buried; rate-limit that emitter
